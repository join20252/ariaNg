...
!(function () {
  ...
  document.addEventListener("contextmenu", function (e) {
    ...
    "TEXTAREA" !== t && "INPUT" !== t && e.preventDefault();
  });
})(),
  (function () {
    "use strict";
    ...
    angular.module("ariaNg").config([
      ...
      function (e) {
        var t =
          "/" +
            JSON.parse(
              localStorage["AriaNg.Options"] || '{"defaultTaskPage":"all"}'
            ).defaultTaskPage || "all";
        e.when("/all", {
      ...
      function (e, t, a, n, i, s, o, r, l, c, d, u, p) {
        var f = !1,
          ...
          v = function () {
            if (c.isBrowserSupportDarkMode()) {
              var t = e.matchMedia("(prefers-color-scheme: dark)");
              l.info(
          ...
          b = function () {
            angular.element('[data-widget="pushmenu"]').PushMenu("collapse");
          },
          k = function (e) {
        ...
        (t.taskContext = {
          ...
          getSelectedTaskIds: function (e) {
            var t = [];
            if (!this.list || !this.selected || this.list.length < 1) return t;
            for (var a = 0; a < this.list.length; a++) {
              var n = this.list[a];
              this.selected[n.gid] &&
                (!e || (e && e.includes(n.status))) &&
                t.push(n.gid);
            }
            return t;
          },
          ...
          isAllSelected: function () {
            for (var e = !0, a = 0; a < this.list.length; a++) {
              var n = this.list[a];
              if (t.filterTask(n) && !this.selected[n.gid]) {
                e = !1;
                break;
              }
            }
          ...
          hasRetryableTask: function () {
            for (var e = 0; e < this.list.length; e++) {
              var a = this.list[e];
              if (t.filterTask(a) && t.isTaskRetryable(a)) return !0;
            }
            return !1;
          },
          hasPausedTask: function () {
            for (var e = 0; e < this.list.length; e++) {
              var a = this.list[e];
              if (t.filterTask(a) && "paused" === a.status) return !0;
            }
            return !1;
          },
          hasCompletedTask: function () {
            for (var e = 0; e < this.list.length; e++) {
              var a = this.list[e];
              if (t.filterTask(a) && "complete" === a.status) return !0;
            }
            return !1;
          },
          selectAll: function () {
            if (
              ...
              for (
                var e = this.isAllSelected(), a = 0;
                a < this.list.length;
                a++
              ) {
                var n = this.list[a];
                t.filterTask(n) && (this.selected[n.gid] = !e);
              }
          },
          selectAllFailed: function () {
            if (
              ...
              for (var e = !0, a = 0; a < this.list.length; a++) {
                ...
                t.filterTask(n) &&
                  t.isTaskRetryable(n) &&
                  (this.selected[n.gid] || (e = !1));
              }
              for (a = 0; a < this.list.length; a++) {
                n = this.list[a];
                t.filterTask(n) &&
                  (t.isTaskRetryable(n)
                    ? (this.selected[n.gid] = !e)
                    : (this.selected[n.gid] = !1));
              }
            }
          },
          selectAllPaused: function () {
            if (
              this.list &&
              this.selected &&
              !(this.list.length < 1) &&
        ...
        (t.clearSearchBox = function () {
          t.searchContext && (t.searchContext.text = "");
        }),
        (t.filterTask = function (e) {
          return (
            !(!e || !angular.isString(e.taskName)) &&
            (!t.searchContext ||
              !t.searchContext.text ||
              e.taskName
                .toLowerCase()
                .indexOf(t.searchContext.text.toLowerCase()) >= 0)
          );
        }),
        ...
        (t.keydownActions = {
          find: function (e) {
            return (
              ...
              t.searchContext.setSearchBoxFocused(),
              !1
            );
          },
        }),
            ...
            c.getSwipeGesture() &&
              (!this.extendRightSwipe ||
                (angular.isFunction(this.extendRightSwipe) &&
                  !this.extendRightSwipe())) &&
              angular.element('[data-widget="pushmenu"]').PushMenu("expand");
          },
        }),
        (t.refreshPage = function () {
          e.location.reload();
        }),
        (t.setAutoRefreshAfterPageLoad = function () {
          f = !0;
        }),
        (t.setTheme = function (e) {
          "system" === e ? v() : "dark" === e ? h() : m();
        }),
        e.addEventListener(
          "keydown",
          function (e) {
            if (c.getKeyboardShortcuts()) {
              var a = angular
                ...
                .is(":focus");
              if (o.isCtrlAPressed(e) && !a) {
                if (angular.isFunction(t.keydownActions.selectAll))
                  return t.keydownActions.selectAll(e);
              } else if (o.isCtrlFPressed(e)) {
                if (angular.isFunction(t.keydownActions.find))
                  return t.keydownActions.find(e);
              } else if (
                o.isDeletePressed(e) &&
                !a &&
                angular.isFunction(t.keydownActions.delete)
              )
                return t.keydownActions.delete(e);
            }
          },
          !0
        ),
        ...
        d.onConnectionSuccess(function () {
          i(function () {
            "Connected" !== t.taskContext.rpcStatus &&
              (t.taskContext.rpcStatus = "Connected"),
              t.taskContext.isRpcOptionsSet ||
                (!(function () {
                  const e = c.getRpcOptions(),
                    a = c.getCurrentRpcDisplayName();
                  u.getGlobalOption(function (n) {
                    if (n.success)
                      try {
                        let i = n.data;
                        for (const t of Object.keys(e)) {
                          let n = e[t] || "",
                            s = i[t] || "";
                          if (
                            ("Bytes" === p[t].suffix && (s = k(s)),
                            s.toLowerCase() !== n.toLowerCase())
                          ) {
                            u.setGlobalOptions(e, function () {
                              r.notifyInPage("", "settings have taken effect", {
                                type: "success",
                                contentPrefix: a + " ",
                              });
                            });
                        ...
                        t.enhanced = "true" === i["enable-extension"];
                      } catch (e) {
                        l.warn("[root.initAria2Options] ", e);
                      }
                  });
                })(),
                (t.taskContext.isRpcOptionsSet = !0));
          });
        }),
        d.onConnectionFailed(function () {
          i(function () {
            "Disconnected" !== t.taskContext.rpcStatus &&
              (t.taskContext.rpcStatus = "Disconnected"),
              t.taskContext.isRpcOptionsSet &&
                (t.taskContext.isRpcOptionsSet = !1);
          });
        }),
        d.onConnectionReconnecting(function () {
          i(function () {
            "Reconnecting" !== t.taskContext.rpcStatus &&
              (t.taskContext.rpcStatus = "Reconnecting"),
              t.taskContext.isRpcOptionsSet &&
                (t.taskContext.isRpcOptionsSet = !1);
          });
        }),
        d.onConnectionWaitingToReconnect(function () {
          i(function () {
            "Waiting to reconnect" !== t.taskContext.rpcStatus &&
              (t.taskContext.rpcStatus = "Waiting to reconnect"),
              t.taskContext.isRpcOptionsSet &&
                (t.taskContext.isRpcOptionsSet = !1);
          });
        }),
        ...
        t.$on("$locationChangeStart", function (e) {
          t.skipLocationChange
            ? (t.skipLocationChange = !1)
            : (s.closeAllDialogs(),
              (t.loadPromise = null),
              delete t.keydownActions.selectAll,
              delete t.keydownActions.delete,
              delete t.swipeActions.extendLeftSwipe,
              delete t.swipeActions.extendRightSwipe,
              angular.isArray(t.taskContext.list) &&
                t.taskContext.list.length > 0 &&
                (t.taskContext.list.length = 0),
              angular.isObject(t.taskContext.selected) &&
                (t.taskContext.selected = {}),
              (t.taskContext.enableSelectAll = !1));
        }),
        t.$on("$routeChangeStart", function (e, t, i) {
          !(function (e) {
            angular.element("section.sidebar > ul li a").removeClass("active"),
              angular.element("ul.nav-sidebar a").each(function (t, a) {
                var n = angular.element(a).attr("href").substring(2);
                g(n, e) && angular.element(a).addClass("active");
              }),
              angular.element("ul.nav-treeview a").each(function (t, a) {
                var n = angular.element(a).attr("href").substring(2);
                g(n, e) &&
                  angular
                    .element(a)
          ...
          e
            ...
            .addEventListener("change", function (e) {
              l.info(
                ...
                "system" === c.getTheme() && (e.matches ? h() : m());
            });
        t.$on("$locationChangeSuccess", function (t, a) {
          f && e.location.reload();
        }),
          "system" === c.getTheme() ? v() : "dark" === c.getTheme() ? h() : m(),
          (function () {
            var e = c.getBrowserFeatures();
            if (
              (e.localStorage ||
                l.warn("[root.initCheck] LocalStorage is not supported!"),
          ...
          angular
            ...
            .on("click", function () {
              angular
                .element("section.sidebar > ul li a")
                .removeClass("active"),
                angular.element(this).addClass("active");
            }),
          angular
            .element(
              "section.sidebar > ul > li > ul.nav-treeview > li[data-href-match] > a"
            )
            .on("click", function () {
              angular
                .element("section.sidebar > ul li a")
  ...
  (function () {
    ...
    angular
      ...
      .constant("ariaNgDefaultOptions", {
        ...
        taskListIndependentDisplayOrder: !0,
  ...
  (function () {
    ...
    angular
      .module("ariaNg")
      .constant("ariaNgBuildConfiguration", {
        buildVersion: "v1.3.8",
        buildCommit: "e92cce8",
      });
  })(),
    ...
    angular.module("ariaNg").config([
      ...
      function (e) {
        e.aHrefSanitizationWhitelist(
          /^\s*(https?|ftp|smb|chrome-extension|file|aria2):/
        );
      },
    ]);
  })(),
    ...
    angular.module("ariaNg").config([
      ...
      function (e, t) {
        e.translations(t.defaultLanguage, {
          ...
          "Select All Failed Tasks": "Select Failed Tasks",
          "Select All Completed Tasks": "Select Completed Tasks",
          ...
          "Support multiple URLs (one URL per line) input, URL/BitTorrent/Metalink file drag-and-drop here.":
            "Support multiple URLs (one URL per line) input, URL/BitTorrent/Metalink file drag-and-drop here.",
          ...
          "Insecure Http and WebSocket would be disabled when accessing AriaNg via Https.":
            "Insecure Http and WebSocket would be disabled when accessing AriaNg via Https.",
          POST: "POST",
          GET: "GET",
          Enabled: "Enabled",
          ...
          options: {
            ...
            "max-connection-per-server.description":
              "Max Connection Per Server is hardcoded to 16, if you want more than this, you need to build your own version of aria2.",
  ...
  (function () {
    ...
    angular
      ...
      .constant("aria2AllOptions", {
        ...
        "no-proxy": { type: "text", separator: ",", showCount: !0 },
        out: { type: "string" },
        "proxy-method": {
          type: "option",
          options: ["get", "tunnel"],
        ...
        "bt-exclude-tracker": { type: "text", separator: ",", showCount: !0 },
        ...
        "bt-tracker": { type: "text", separator: ",", showCount: !0 },
  ...
  (function () {
    ...
    angular.module("ariaNg").controller("CommandController", [
      ...
      function (e, t, a, n, i, s, o, r, l, c) {
        var d = a.path();
        (function (n, d) {
          return 0 === n.indexOf("/new")
            ? (function (t, n) {
                try {
                  t = s.base64UrlDecode(t);
                } catch (e) {
                  return s.showError("URL is not base64 encoded!"), !1;
                }
                var i = {},
                  r = !1;
                if (n) {
                  for (var d in n)
                    n.hasOwnProperty(d) &&
                      c.isOptionKeyValid(d) &&
                      (i[d] = n[d]);
                  "true" === n.pause && (r = !0);
                }
                return (
                  (e.loadPromise = l.newUriTask(
                    { urls: [t], options: i },
                    r,
                    function (e) {
                      if (!e.success) return !1;
                      r ? a.path("/waiting") : a.path("/downloading");
                    }
                  )),
            ...
            ? (function (e, n, l, c, d) {
                if (
                  ...
                  return s.showError("Protocol is invalid!"), !1;
                if (!n) return s.showError("RPC host cannot be empty!"), !1;
                if (d)
                  try {
                    d = s.base64UrlDecode(d);
                  } catch (e) {
                    return s.showError("RPC secret is not base64 encoded!"), !1;
                  }
                var u = {
                  rpcAlias: "",
                  rpcHost: n,
                ...
                return (
                  r.isRpcSettingEqualsDefault(u)
                    ? a.path("/downloading")
                    : (r.setDefaultRpcSetting(u, {
                        keepCurrent: !1,
                        forceSet: !0,
                      }),
                      a.path("/downloading"),
              ...
              })(d.protocol, d.host, d.port, d.interface, d.secret)
            : (s.showError("Parameter is invalid!"), !1);
        })(d, angular.extend({}, n, a.search())) || a.path("/downloading");
      },
    ]);
  })(),
  (function () {
        ...
        var f = [
          ...
          m = function () {
            for (var e = [], t = 0; t < f.length; t++)
              f[t].show && e.push(f[t].name);
            return e;
          };
        (t.context = {
          currentTab: "logs",
          logMaxCount: o.cachedDebugLogsLimit,
          logAutoRefreshAvailableInterval: r.getTimeOptions(
            [100, 200, 500, 1e3, 2e3],
            !0
          ),
          ...
          (t.changeTab = function (a) {
            "rpc" === a &&
              (e.loadPromise = (function () {
                if (
                  !t.context.availableRpcMethods ||
                  !t.context.availableRpcMethods.length
                )
                  return p.listMethods({
                    silent: !1,
                    callback: function (e) {
                      e.success && (t.context.availableRpcMethods = e.data);
                    },
                  });
              })()),
              (t.context.currentTab = a);
          }),
          (t.changeLogListDisplayOrder = function (e) {
            var a = r.parseOrderType(t.context.logListDisplayOrder),
              n = r.parseOrderType(e);
            n.type === a.type && (n.reverse = !a.reverse),
              (t.context.logListDisplayOrder = n.getValue());
          }),
          (t.isLogListSetDisplayOrder = function (e) {
            var a = r.parseOrderType(t.context.logListDisplayOrder),
              n = r.parseOrderType(e);
            return a.equals(n);
          }),
          (t.getLogListOrderType = function () {
            return t.context.logListDisplayOrder;
          }),
          (t.filterLog = function (e) {
            return (
              !(!e || !angular.isString(e.level)) &&
              (!t.context.logLevelFilter ||
                c.compareLogLevel(e.level, t.context.logLevelFilter) >= 0)
            );
          }),
          (t.setLogLevelFilter = function (e) {
            t.context.logLevelFilter = e;
          }),
          (t.isSetLogLevelFilter = function (e) {
            return t.context.logLevelFilter === e;
          }),
          (t.getLogLevelFilter = function () {
            return t.context.logLevelFilter;
          }),
          (t.setAutoRefreshInterval = function (e) {
            (t.context.logAutoRefreshInterval = e),
              g && n.cancel(g),
              e > 0 &&
                (t.reloadLogs(),
                (g = n(function () {
                  t.reloadLogs();
                }, t.context.logAutoRefreshInterval)));
          }),
          (t.reloadLogs = function () {
            t.context.logs = c.getDebugLogs().slice();
          }),
          (t.clearDebugLogs = function () {
            r.confirm(
              "Confirm Clear",
              "Are you sure you want to clear debug logs?",
              "warning",
              function () {
                c.clearDebugLogs(), t.reloadLogs();
              },
              !1
            );
          }),
          (t.showLogDetail = function (e) {
            (t.context.currentLog = e),
              angular.element("#log-detail-modal").modal();
          }),
          $("#log-detail-modal").on("hide.bs.modal", function (e) {
            t.context.currentLog = null;
          }),
          (t.executeAria2Method = function () {
            if (
              !t.context.rpcRequestMethod ||
              t.context.rpcRequestMethod.indexOf(".") < 0
            )
              r.showError("RPC method is illegal!");
            else {
              var e = t.context.rpcRequestMethod.split(".");
              if (2 === e.length) {
                var a = e[1];
                if (angular.isFunction(p[a])) {
                  var n = {
                      silent: !1,
                      callback: function (e) {
                        t.context.rpcResponse = e
                          ? s("json")(e.data)
                          : s("json")(e);
                      },
                    },
                    i = {};
                  try {
                    i = angular.fromJson(t.context.rpcRequestParameters);
                  } catch (e) {
                    return (
                      c.error(
                        "[AriaNgDebugController.executeAria2Method] failed to parse request parameters: " +
                          t.context.rpcRequestParameters,
                        e
                      ),
          ...
          (t.requestParametersTextboxKeyDown = function (e) {
            if (u.getKeyboardShortcuts())
              return d.isCtrlEnterPressed(e) && t.executeMethodForm.$valid
                ? (e.preventDefault && e.preventDefault(),
                  t.executeAria2Method(),
                  !1)
                : void 0;
          }),
          ...
          (e.swipeActions.extendLeftSwipe = function () {
            var e = m(),
              a = e.indexOf(t.context.currentTab);
            return a < e.length - 1 && (t.changeTab(e[a + 1]), !0);
          }),
          (e.swipeActions.extendRightSwipe = function () {
            var e = m(),
              a = e.indexOf(t.context.currentTab);
            return a > 0 && (t.changeTab(e[a - 1]), !0);
          }),
          (e.loadPromise = i(function () {
            u.isEnableDebugMode()
              ? t.setAutoRefreshInterval(t.context.logAutoRefreshInterval)
              : r.showError("Access Denied!", function () {
                  u.isEnableDebugMode() || a.path("/settings/ariang");
                });
          }, 100));
      },
    ]);
  ...
  (function () {
    ...
    angular.module("ariaNg").controller("MainController", [
      ...
      "ariaNgKeyboardService",
      "aria2eRecService",
      function (e, t, a, n, i, s, o, r, l, c, d, u, p, f, g, m, h, v, b) {
        var k = null,
          y = null;
        e.defaultTaskPage = p.getDefaultTaskPage();
        var w = "/" + e.defaultTaskPage,
          S = function () {
            var e = i.path().substring(1);
            return "all" === e ||
              "downloading" === e ||
              "waiting" === e ||
              "stopped" === e
          ...
          x = function () {
            var e = g.getFinalTitleByGlobalStat({
              globalStat: t.globalStat,
              currentRpcProfile: C(),
            });
            s[0].title = e;
          },
          ...
          C = function () {
            if (!t.rpcSettings || t.rpcSettings.length < 1) return null;
            for (var e = 0; e < t.rpcSettings.length; e++) {
              var a = t.rpcSettings[e];
              if (a.isDefault) return a;
            }
            return null;
          };
        p.getBrowserNotification() && u.requestBrowserPermission(),
          (t.ariaNgVersion = d.getBuildVersion()),
          ...
          (t.currentRpcProfile = C()),
          (t.currentRpcAlias = p.getCurrentRpcDisplayName()),
          (t.isCurrentRpcUseWebSocket = p.isCurrentRpcUseWebSocket()),
          (t.isTaskSelected = function () {
            return e.taskContext.getSelectedTaskIds().length > 0;
          }),
          (t.isSelectedTasksAllHaveUrl = function () {
            var t = e.taskContext.getSelectedTasks();
            if (t.length < 1) return !1;
            for (var a = 0; a < t.length; a++) if (!t[a].singleUrl) return !1;
            return !0;
          }),
          (t.isSelectedTasksAllHaveInfoHash = function () {
            var t = e.taskContext.getSelectedTasks();
            if (t.length < 1) return !1;
            for (var a = 0; a < t.length; a++)
              if (!t[a].bittorrent || !t[a].infoHash) return !1;
            return !0;
          }),
          ...
          (t.changeTasksState = function (n) {
            var s = "",
              o = null;
            if ("start" === n) (s = "paused"), (o = m.startTasks);
            else {
              if ("pause" !== n) return;
              (s = "active+waiting"), (o = m.pauseTasks);
            }
            var r = e.taskContext.getSelectedTaskIds(s);
                ...
                (e.loadPromise = o(
                  ...
                  function (e) {
                    if (
                      (e.hasError &&
                        r.length > 1 &&
                        c.showError("Failed to change some tasks state."),
                      !e.hasSuccess)
                    )
                      return;
                    let s = t.globalStat;
                      ...
                      e.success &&
                        ...
                        ("task-list-default" === t
                          ...
                          ? "/downloading" !== i.path()
                            ...
                            : a.reload()
                          : "task-detail" === t
                          ? i.path("/task/detail/" + e.data)
                          : a.reload());
                    } else c.showError("Failed to retry this task.");
                  },
                  !1
                );
              }
          ...
          (t.hasPausedTask = function () {
            return e.taskContext.hasPausedTask();
          }),
          (t.hasRetryableTask = function () {
            return e.taskContext.hasRetryableTask();
          }),
          (t.hasCompletedTask = function () {
            return e.taskContext.hasCompletedTask();
          }),
          (t.isSelectedTaskRetryable = function () {
            var t = e.taskContext.getSelectedTasks();
            if (t.length < 1) return !1;
            for (var a = 0; a < t.length; a++)
              if (!e.isTaskRetryable(t[a])) return !1;
            return !0;
          }),
          (t.retryTasks = function () {
            var n = e.taskContext.getSelectedTasks();
            if (((e.taskContext.selected = {}), n && !(n.length < 1))) {
              if (1 === n.length) return t.retryTask(n[0]);
              for (var s = [], o = 0, r = 0; r < n.length; r++)
                e.isTaskRetryable(n[r]) ? s.push(n[r]) : o++;
              c.confirm(
                "Confirm Retry",
                "Are you sure you want to retry the selected task? AriaNg will create same task after clicking OK.",
                "info",
                ...
                null,
                function (t) {
                  e.loadPromise = m.retryTasks(s, function (e) {
                    t(e);
                  });
                }
              );
          ...
          (t.removeTasks = function (t) {
            var n = e.taskContext.getSelectedTasks();
            if (((e.taskContext.selected = {}), !n || n.length < 1)) return;
            var s = function (t) {
              e.loadPromise = m.removeTasks(
                n,
                function (e) {
                  e.hasError &&
                    n.length > 1 &&
                    c.showError("Failed to remove some task(s)."),
                    e.hasSuccess &&
                      (T(!0),
                      e.hasError ||
                        ("/downloading" == i.path()
                          ? i.path("/stopped")
                          : i.path().startsWith("/task/detail")
                          ? i.path(w)
                          : a.reload()));
                },
                n.length > 1,
            ...
            const o = v.isShiftKeyPressed(t);
            if (p.getConfirmTaskRemoval() || o) {
              let t = null;
              e.enhanced &&
                (t = {
                  input: "checkbox",
                  inputValue: o,
                  inputPlaceholder: "Remove downloaded file(s) simultaneously",
                }),
                c.confirm(
                  "Confirm Remove",
                  "Are you sure you want to remove the selected task?",
            ...
            c.confirm(
              ...
              function () {
                e.loadPromise = m.clearStoppedTasks(function (e) {
                  e.success &&
                    (T(!0), "/stopped" !== i.path() ? i.path(w) : a.reload());
                });
              }
            );
          }),
          ...
          (t.selectAllPausedTasks = function () {
            e.taskContext.selectAllPaused();
          }),
          (t.selectAllFailedTasks = function () {
            e.taskContext.selectAllFailed();
          }),
          (t.selectAllCompletedTasks = function () {
            e.taskContext.selectAllCompleted();
          }),
          (t.copySelectedTasksDownloadLink = function () {
            for (
              var t = e.taskContext.getSelectedTasks(), a = "", n = 0;
              n < t.length;
              n++
            )
              n > 0 && (a += "\n"), (a += t[n].singleUrl);
            a.length > 0 && r.copyText(a);
          }),
          (t.copySelectedTasksMagnetLink = function () {
            for (
              var t = e.taskContext.getSelectedTasks(), a = "", n = 0;
              n < t.length;
              n++
              ...
              n > 0 && (a += "\n"),
                (a += "magnet:?xt=urn:btih:" + t[n].infoHash);
            a.length > 0 && r.copyText(a);
          }),
          (t.changeDisplayOrder = function (e, t) {
            var a = S(),
              n = c.parseOrderType(p.getDisplayOrder(a)),
              i = c.parseOrderType(e);
            t && i.type === n.type && (i.reverse = !n.reverse),
              p.setDisplayOrder(i.getValue(), a);
          }),
          (t.isSetDisplayOrder = function (e) {
            var t = S(),
              a = c.parseOrderType(p.getDisplayOrder(t)),
              n = c.parseOrderType(e);
            return a.equals(n);
          }),
          (t.showQuickSettingDialog = function (e, a) {
            t.quickSettingContext = { type: e, title: a };
          }),
          (t.switchRpcSetting = function (t) {
            t.isDefault ||
              (p.setDefaultRpcSetting(t),
              0 === i.path().indexOf("/task/detail/") ||
              0 === i.path().indexOf("/settings/aria2/")
                ? (e.setAutoRefreshAfterPageLoad(), i.path(w))
                : n.location.reload());
          }),
          (t.getOpenHandlerUrl = function (e, a) {
            if (!t.currentRpcProfile || !t.currentRpcProfile.openHandlerUrl)
              return "";
            let n = t.currentRpcProfile.openHandlerUrl;
            if ("string" != typeof e || "string" != typeof n) return "";
            let i = "";
            const s = n.match(/\${relativepath:(\d+)}/);
            if (s) {
              const t = parseInt(s[1]);
              i = t ? c.getRelativeDir(e, t) : "";
            }
            return n
              .replace("${taskdir}", e)
              .replace(/\${relativepath:(\d+)}/, i)
              .replace("${taskname}", a);
          }),
          p.getTitleRefreshInterval() > 0 &&
            (k = o(function () {
              x();
            }, p.getTitleRefreshInterval())),
          p.getGlobalStatRefreshInterval() > 0 &&
            (y = o(function () {
              T(!0);
            }, p.getGlobalStatRefreshInterval())),
          b
            .getRecManifestPromise()
            .then(function (t) {
              if (t) {
                try {
                  var a = n.navigator.language,
                    s = p.getRecCount(),
                    o = t.contents[0].regions || [],
                    r = t.total > s,
                    l = o.includes("all") || o.includes(a);
                  (e.hasNewRec = r && l), (e.recTotal = t.total);
                } catch (t) {
                  (e.hasNewRec = !1), (e.recTotal = s);
                }
                0 === i.path().indexOf("/recommend") &&
                  p.setRecCount(e.recTotal);
              } else e.hasNewRec = !1;
            })
            .catch(function (t) {
              (e.hasNewRec = !1), (e.recTotal = p.getRecCount());
            }),
          (t.updateRecCount = function () {
            p.setRecCount(e.recCount), (e.hasNewRec = !1);
          }),
          (t.compactMode = p.getCompactMode()),
          t.$watch("compactMode", function (e, t) {
            p.setCompactMode(e);
          }),
          t.$on("$destroy", function () {
            k && o.cancel(k), y && o.cancel(y);
          }),
          T(!0, function () {
            x();
          });
    ...
    angular.module("ariaNg").controller("NewTaskController", [
      ...
      function (e, t, a, n, i, s, o, r, l, c, d, u, p) {
        var f,
          ...
          v = function (e) {
            e && e.dir && u.addSettingHistory("dir", e.dir);
          },
          b = function (e) {
            var a = i.parseUrlsFromOriginInput(t.context.urls),
              n = [];
            e || (e = angular.copy(t.context.options));
            for (var s = 0; s < a.length; s++)
              "" !== a[s] &&
                "" !== a[s].trim() &&
                n.push({ urls: [a[s].trim()], selected: !1, options: e });
            return n;
          },
          k = function (e, a) {
            var n = angular.copy(t.context.options),
              i = b(n);
            return (
              v(n),
              (function (e) {
                e &&
                  e["all-proxy"] &&
                  (u.addSettingHistory("all-proxy", e["all-proxy"]),
                  e["all-proxy-user"] &&
                    u.addSettingHistory("all-proxy-user", e["all-proxy-user"]));
              })(n),
              d.newUriTasks(i, e, a)
            );
          };
        if (
          ((t.context = {
            ...
            lastChecked: -1,
            availableOptions:
              ((f = u.getNewTaskOptionKeys()),
              u.getSpecifiedOptions(f, { disableRequired: !0 })),
            globalOptions: null,
            options: {},
            optionFilter: { global: !0, http: !1, bittorrent: !1 },
            exportCommandApiOptions: null,
            hasDownloadsPermission: i.hasDownloadsPermission(),
          }),
          ...
          (t.loadDefaultOption = function () {
            t.context.globalOptions ||
              (e.loadPromise = u.getGlobalOption(function (e) {
          ...
          try {
            t.context.urls = decodeURI(i.base64UrlDecode(m.url));
          } catch (e) {
            s.error("[NewTaskController] base64 decode error, url=" + m.url, e);
          }
          t.context.urls?.startsWith("http") &&
            ((t.context.optionFilter.http = !0),
            t.context.urls.includes("\n") ||
              n(
                function () {
                  "Connected" == e.taskContext.rpcStatus &&
                    t.changeTab("options");
                },
                1440,
                !1
              )),
            m.referer && (t.context.options.referer = m.referer),
            m.header && (t.context.options.header = m.header),
            m.filename &&
              (t.context.options.out = decodeURIComponent(m.filename));
        }
        (t.openTorrent = function () {
          r.openFileContent(
            { scope: t, fileFilter: ".torrent", fileType: "binary" },
            function (e) {
          ...
          (t.openMetalink = function () {
            r.openFileContent(
              { scope: t, fileFilter: ".meta4,.metalink", fileType: "binary" },
              function (e) {
                (t.context.uploadFile = e),
          ...
          (t.dragEnterHandler = function (e, t) {
            e.preventDefault(), t.focus(), t.addClass("has-warning");
            let a = e.originalEvent.dataTransfer.items;
            (a.length > 1 || "file" != a[0].kind) &&
              t.removeClass("has-warning").addClass("has-error");
          }),
          (t.dragLeaveHandler = function (e, t) {
            e.preventDefault(),
              t.blur(),
              t.removeClass("has-warning has-error");
          }),
          (t.dropHandler = function (e, a) {
            e.preventDefault(), a.removeClass("has-warning has-error");
            const n = e.originalEvent.dataTransfer.files,
              s = e.originalEvent.dataTransfer.items;
            if (1 != n.length) {
              for (const e of s)
                "string" == e.kind &&
                  "text/uri-list" == e.type &&
                  (t.context.urls && !t.context.urls.endsWith("\n")
                    ? (t.context.urls += "\n")
                    : angular.isUndefined(t.context.urls) &&
                      (t.context.urls = ""),
            ...
            const o = n[0];
            if (o.name.endsWith(".torrent")) t.context.taskType = "torrent";
            else {
              if (!o.name.endsWith(".meta4") && !o.name.endsWith(".metalink"))
                return;
              t.context.taskType = "metalink";
            }
            const r = { fileName: o.name };
            var l = new FileReader();
            (l.onload = function () {
              (r.base64Content = l.result.replace(/.*?base64,/, "")),
                (t.context.uploadFile = r),
                "torrent" == t.context.taskType &&
                  (t.context.optionFilter.bittorrent = !0),
                t.changeTab("options");
            }),
              (l.onerror = function () {
                i.showError("Failed to load file!");
              }),
              l.readAsDataURL(o);
          }),
          (t.isNewTaskValid = function () {
            return !!t.context.uploadFile || t.newTaskForm.$valid;
          }),
          (t.startDownload = function (n, i) {
            var s = function (e) {
              if (e.hasSuccess || e.success) {
                ...
                e.results && e.results.length > 0
                  ? (t = e.results[0])
                  : e && (t = e),
                  "task-detail" === c.getAfterCreatingNewTask() && t && t.data
            ...
            "urls" === t.context.taskType
              ? t.context.hasDownloadsPermission &&
                "Connected" !== e.taskContext.rpcStatus
                ? (p.notifyInPage(
                    "",
                    "Aria2 is disconnected, All tasks will be downloaded via Browser. Invalid URL will be ignored.",
                    { type: "info", delay: 6e3 }
                  ),
                  (e.loadPromise = t.invokeBrowserDownload(i)))
                : (e.loadPromise = k(n, s))
              : "torrent" === t.context.taskType
              ? (e.loadPromise = (function (e, a) {
                  var n = angular.copy(t.context.options),
                    i = {
                      content: t.context.uploadFile.base64Content,
                      options: n,
                    };
                  return v(i.options), d.newTorrentTask(i, e, a);
                })(n, s))
              : "metalink" === t.context.taskType &&
                (e.loadPromise = (function (e, a) {
                  var n = {
                    content: t.context.uploadFile.base64Content,
                    options: angular.copy(t.context.options),
                  };
                  return v(n.options), d.newMetalinkTask(n, e, a);
                })(n, s));
          }),
          (t.invokeBrowserDownload = function (e) {
            let n = function () {
              "all" === c.getDefaultTaskPage()
                ? a.path("/all")
                : a.path("/downloading");
            };
            if (t.context.hasDownloadsPermission) {
              let a = i.parseUrlsFromOriginInput(
                t.context.urls,
                "^(https?|ftp)://.+$"
              );
              if (a.length > 1)
                i.confirm(
                  ...
                  "warning",
                  function () {
                    let e = { url: t.context.urls };
                    chrome.runtime
                      .sendMessage({ type: "DOWNLOAD_VIA_BROWSER", data: e })
                      .then(n);
                  },
                  !1,
                  null,
                ...
                let e = {
                  url: t.context.urls,
                  filename: t.context.options.out,
                };
          ...
          (t.showExportCommandAPIModal = function () {
            t.context.exportCommandApiOptions = { type: "new-task", data: b() };
          }),
          (t.setOption = function (e, a, n) {
            "" === a && u.isOptionKeyRequired(e)
              ? delete t.context.options[e]
              : (t.context.options[e] = a),
              n.setReady();
          }),
          (t.urlTextboxKeyDown = function (e) {
            if (c.getKeyboardShortcuts())
              return o.isCtrlEnterPressed(e) && t.newTaskForm.$valid
                ? (e.preventDefault && e.preventDefault(),
                  t.startDownload(),
                  !1)
                : void 0;
          ...
          (t.getValidUrlsCount = function () {
            let e = 0;
            if (t.context.showUrlFilter)
              for (const a of t.pendingTasks)
                t.filterTask(a) && a.selected && e++;
            else {
              var a = i.parseUrlsFromOriginInput(t.context.urls);
              e = a ? a.length : 0;
            }
          ...
          (t.showUrlFilter = function () {
            t.context.showUrlFilter
              ? t.cancelUrlFilter()
              : ((t.pendingTasks && !t.newTaskForm.urls.$dirty) ||
                  (t.pendingTasks = b()),
                (t.context.showUrlFilter = !0));
          }),
          (t.cancelUrlFilter = function () {
            t.context.showUrlFilter && (t.context.showUrlFilter = !1);
          }),
          (t.isAnyFileSelected = function () {
            if (!t.pendingTasks || !t.pendingTasks.length) return !1;
            for (var e = 0; e < t.pendingTasks.length; e++) {
              var a = t.pendingTasks[e];
              if (t.filterTask(a) && a.selected) return !0;
            }
            return !1;
          }),
          (t.isAllFileSelected = function () {
            ...
            for (var e = 0; e < t.pendingTasks.length; e++) {
              var a = t.pendingTasks[e];
              if (t.filterTask(a) && !a.selected) return !1;
            }
            return !0;
          }),
          (t.selectFiles = function (e) {
            if (t.pendingTasks && t.pendingTasks.length) {
              "auto" === e && (e = t.isAllFileSelected() ? "none" : "all");
              for (var a = 0; a < t.pendingTasks.length; a++) {
                var n = t.pendingTasks[a];
                t.filterTask(n) &&
                  ("all" === e
                    ? (n.selected = !0)
                    : "none" === e
                    ? (n.selected = !1)
                    : "reverse" === e && (n.selected = !n.selected));
              }
            }
          }),
          (t.chooseSpecifiedFiles = function (e) {
            if (t.pendingTasks && t.pendingTasks.length && l[e]) {
              for (
                var a = t.pendingTasks,
                  n = l[e].extensions,
                  s = [],
                  o = !0,
                  r = 0;
                ...
                var c = a[r];
                if (t.filterTask(c)) {
                  var d = i.getFileExtensionFromUrl(c.urls[0]);
                  d && (d = d.toLowerCase()),
                    n.indexOf(d) >= 0 && (s.push(r), c.selected || (o = !1));
                }
              }
              for (r = 0; r < s.length; r++) {
                (c = a[s[r]]) && (c.selected = !o);
              }
            }
          }),
          (t.saveChosenFiles = function () {
            if (t.context.showUrlFilter) {
              let e = [];
              for (const a of t.pendingTasks)
                t.filterTask(a) && a.selected && e.push(a.urls[0]);
              (t.context.urls = e.join("\n")), (t.context.showUrlFilter = !1);
            }
          }),
          (t.showCustomChooseFileModal = function () {
            if (t.pendingTasks && t.pendingTasks.length) {
              for (var e = t.pendingTasks, a = {}, n = 0; n < e.length; n++) {
                var s = e[n];
                if (
                  ((g = i.getFileExtensionFromUrl(s.urls[0])) &&
                    (g = g.toLowerCase()),
                  !(m = a[g]))
                ) {
                  var o = g;
                  o.length > 0 && "." === o.charAt(0) && (o = o.substring(1)),
                    (m = {
                      extension: o,
                      classified: !1,
                      selected: !1,
              ...
              for (var c in l)
                if (l.hasOwnProperty(c)) {
                  ...
                  for (n = 0; n < u.length; n++) {
                    (m = a[(g = u[n])]) && ((m.classified = !0), p.push(m));
                  }
                  p.length > 0 && (r[c] = { name: d, extensions: p });
                }
              var f = [];
              for (var g in a) {
                var m;
                if (a.hasOwnProperty(g)) (m = a[g]).classified || f.push(m);
              }
              f.length > 0 && (r.other = { name: "Other", extensions: f }),
                (t.context.fileExtensions = r),
                angular.element("#custom-choose-file-modal").modal();
            }
          }),
          (t.setSelectedExtension = function (e, a) {
            if (t.pendingTasks && t.pendingTasks.length)
              for (var n = t.pendingTasks, s = 0; s < n.length; s++) {
                var o = n[s],
                  r = i.getFileExtensionFromUrl(o.urls[0]);
                r && (r = r.toLowerCase()), r === "." + e && (o.selected = a);
              }
          }),
          (t.onTaskClick = function (e, a) {
            let n = t.context.lastChecked,
              i = t.pendingTasks;
            if (e < 0 || !Array.isArray(i) || i.length < 1) return;
            let s = (i[e].selected = !i[e].selected);
            if (a.shiftKey && -1 !== n) {
              let t = n < e ? 1 : -1;
              for (let a = n; a != e; a += t) i[a].selected = s;
            }
            t.context.lastChecked = e;
          }),
          (t.filterTask = function (t) {
            return (
              !(!t || !angular.isString(t.urls[0])) &&
              (!e.searchContext ||
                !e.searchContext.text ||
                t.urls[0]
                  .toLowerCase()
                  .indexOf(e.searchContext.text.toLowerCase()) >= 0)
            );
          }),
          (e.keydownActions.selectAll = function (e) {
            return (
              e.preventDefault && e.preventDefault(),
              t.$apply(function () {
                t.selectFiles("auto");
  ...
  (function () {
    ...
    angular.module("ariaNg").controller("DownloadListController", [
      ...
      "aria2TaskService",
      "ariaNgKeyboardService",
      function (e, t, a, n, i, s, o, r, l, c, d, u) {
        var p = n.path().substring(1),
          f = null,
          g = !1,
          m = !0,
          h = -1,
                  ...
                  if (!g)
                    if (t.success) {
                      var a = t.context.requestWholeInfo,
                        n = t.data;
                      if (a) (e.taskContext.list = n), (m = !1);
                      else {
                        if (e.taskContext.list && e.taskContext.list.length > 0)
                          for (var i = 0; i < e.taskContext.list.length; i++) {
                            delete (c = e.taskContext.list[i]).verifiedLength,
                              delete c.verifyIntegrityPending;
                          }
                        m = !l.extendArray(n, e.taskContext.list, "gid");
                      }
                      if (
                        e.taskContext.list &&
                        e.taskContext.list.length > 0 &&
                        (d.processDownloadTasks(e.taskContext.list), !a)
                      ) {
                        var o = !1;
                        for (i = 0; i < e.taskContext.list.length; i++) {
                          var c;
                          if (
                            (c = e.taskContext.list[i]).hasTaskName ||
                            c.files ||
                            c.bittorrent
                          ) {
                            o = !0;
                        ...
                        if (!o)
                          return (m = !0), void (e.taskContext.list.length = 0);
                      }
                      e.taskContext.enableSelectAll =
                        e.taskContext.list && e.taskContext.list.length > 0;
                    } else
                      t.data.message === r.Unauthorized.message && s.cancel(f);
                },
                t
              );
          };
        (t.getOrderType = function () {
          return c.getDisplayOrder(p);
        }),
          (t.openDownloadFolder = function (e, i) {
            if (
              (e.stopPropagation(),
              0 !== e.button || !i.files || i.files.length < 1)
            )
              return;
            let s =
              "aria2://browse/path=" +
              (i.files.length > 1 ? i.dir + i.taskName : i.files[0].path);
            t.currentRpcProfile &&
              t.currentRpcProfile.openHandlerUrl &&
              (s = t.getOpenHandlerUrl(i.dir, i.taskName)),
              (a.location.href = s),
              setTimeout(() => {
                v ||
                  l.confirm(
                    "Install Aria2 Manager",
                    "Aria2 Manager is not installed, go to Alex Recommends channel for more information?",
                    "info",
                    function () {
                      n.path("recommend")
                        .search("path", "/posts/3")
          ...
          (t.onTaskClick = function (t, a, n) {
            if (t < 0 || !Array.isArray(n) || n.length < 1) return;
            let i = n[t].gid,
              s = c.getKeyboardShortcuts(),
              o = a.originalEvent?.sourceCapabilities?.firesTouchEvents || !1;
            if (2 == a.button && e.taskContext.selected[i]) return;
            if (
              !(
                o ||
                (0 == a.button &&
                  ((!s && !u.isModifierKeyPressed(a)) ||
                    (s && u.isModifierKeyPressed(a)) ||
                    a.shiftKey))
              )
            )
              for (const t in e.taskContext.selected)
                t !== i && (e.taskContext.selected[t] = !1);
            let r = (e.taskContext.selected[i] = !e.taskContext.selected[i]);
            if (a.shiftKey && 0 == a.button && -1 !== h) {
              let a = h < t ? 1 : -1;
              for (let s = h; s != t; s += a)
                (i = n[s].gid), (e.taskContext.selected[i] = r);
            }
            h = t;
          }),
          (t.isSupportDragTask = function () {
            if (!c.getDragAndDropTasks()) return !1;
            var e = l.parseOrderType(c.getDisplayOrder(p));
            return "waiting" === p && "default" === e.type;
          }),
          c.getDownloadTaskRefreshInterval() > 0 &&
            (f = s(function () {
              b(!0);
          ...
          (e.keydownActions.delete = function (e) {
            return (
              e.preventDefault && e.preventDefault(),
              t.$apply(function () {
                t.removeTasks(e);
          ...
          (t.isRpcLocalhost = c.isCurrentRpcLocalhost()),
          (t.location = p);
      },
    ]);
  })(),
  (function () {
    ...
    angular.module("ariaNg").controller("TaskDetailController", [
      ...
      function (e, t, a, n, i, s, o, r, l, c, d, u, p) {
        var f = [
          ...
          k = function (e, a) {
            ...
            !v ||
              ...
              !t.context ||
              t.context.currentTab !== e ||
              ((t.context.currentTab = "overview"), (v = !1));
          },
          y = function (a) {
            var n, i, s;
            a &&
              ((t.context.showPiecesInfo = (function (e) {
                var t = c.getShowPiecesInfoInTaskDetailPage();
                return (
                  !(!e || "never" === t) &&
                  ("le102400" === t
                    ? e.numPieces <= 102400
                    : "le10240" === t
                    ? e.numPieces <= 10240
                    : "le1024" !== t || e.numPieces <= 1024)
                );
              })(a)),
              k("pieces", t.context.showPiecesInfo),
              k("btpeers", "active" === a.status && a.bittorrent),
              (v = !1),
              (t.task && t.task.status === a.status) ||
                (t.context.availableOptions =
                  ((n = a.status),
                  (i = !!a.bittorrent),
                  (s = p.getAvailableTaskOptionKeys(n, i)),
                  p.getSpecifiedOptions(s, { disableRequired: !0 }))),
              t.task &&
                (delete t.task.verifiedLength,
                delete t.task.verifyIntegrityPending),
              (t.task = l.copyObjectTo(a, t.task)),
              (t.task.dir = l.formatFilePath(a.dir)),
              (e.taskContext.list = [t.task]),
              (e.taskContext.selected = {}),
              (e.taskContext.selected[t.task.gid] = !0),
              d.recordStat(a.gid, a));
          },
          w = function (e) {
            e &&
              (l.extendArray(e, t.context.btPeers, "peerId") ||
                (t.context.btPeers = e),
              (t.context.healthPercent = u.estimateHealthPercentFromPeers(
                t.task,
                t.context.btPeers
              )));
          },
            ...
            if (!m) {
              ...
              return t.task
                ...
                : u.getTaskStatus(
                    a.gid,
                    function (t) {
                      if (!t.success) return n(t.data.message);
                      var a = t.data;
                      y(a),
                        S(a) &&
                          u.getBtTaskPeers(
          ...
          T = function (e) {
            if (t.task && t.task.files) {
              for (
                var a = t.task.gid, n = [], i = 0;
                i < t.task.files.length;
                i++
              ) {
          ...
          P = function (e) {
            if (e) {
              ...
              (e.selected = t > 0 && t === e.subDirs.length + e.files.length),
                (e.partialSelected =
                  (t > 0 && t < e.subDirs.length + e.files.length) || a > 0);
            }
          },
          R = function () {
        ...
        (t.context = {
          currentTab: a.tab || "overview",
          isEnableSpeedChart: c.getDownloadTaskRefreshInterval() > 0,
          showPiecesInfo: "never" !== c.getShowPiecesInfoInTaskDetailPage(),
          ...
          healthPercent: 0,
          collapseTrackers: !0,
          statusData: d.getEmptyStatsData(a.gid),
          availableOptions: [],
          options: [],
        }),
          (t.changeTab = function (a) {
            "settings" === a && t.loadTaskOption(t.task),
              (t.context.currentTab = a),
              (e.skipLocationChange = !0),
              n.search("tab", a).replace();
          }),
          (e.swipeActions.extendLeftSwipe = function () {
            var e = b(),
              a = e.indexOf(t.context.currentTab);
          ...
          (t.changeFileListDisplayOrder = function (e, a) {
            if (!t.task || !t.task.multiDir) {
              var n = l.parseOrderType(c.getFileListDisplayOrder()),
                i = l.parseOrderType(e);
              a && i.type === n.type && (i.reverse = !n.reverse),
                c.setFileListDisplayOrder(i.getValue());
            }
          }),
          (t.isSetFileListDisplayOrder = function (e) {
            var t = l.parseOrderType(c.getFileListDisplayOrder()),
              a = l.parseOrderType(e);
            return t.equals(a);
          }),
          (t.getFileListOrderType = function () {
            return t.task && t.task.multiDir
              ? null
              : c.getFileListDisplayOrder();
          }),
          (t.showChooseFilesToolbar = function () {
            t.context.showChooseFilesToolbar
              ? t.cancelChooseFiles()
              : ((m = !0), (t.context.showChooseFilesToolbar = !0));
          }),
          (t.isAnyFileSelected = function () {
            if (!t.task || !t.task.files) return !1;
            for (var e = 0; e < t.task.files.length; e++) {
              var a = t.task.files[e];
              if (!a.isDir && a.selected) return !0;
            }
            return !1;
          }),
          (t.isAllFileSelected = function () {
            ...
            for (var e = 0; e < t.task.files.length; e++) {
              var a = t.task.files[e];
              if (!a.isDir && !a.selected) return !1;
            }
            return !0;
          }),
          (t.selectFiles = function (e) {
          ...
          (t.chooseSpecifiedFiles = function (e) {
            if (t.task && t.task.files && r[e]) {
              for (
                ...
                if (!(d = a[o]).isDir) {
                  var c = l.getFileExtension(d.fileName);
                  c && (c = c.toLowerCase()),
                    n.indexOf(c) >= 0 && (i.push(o), d.selected || (s = !1));
                }
              }
              for (o = 0; o < i.length; o++) {
                var d;
                (d = a[i[o]]) && !d.isDir && (d.selected = !s);
              }
              R();
            }
          }),
          ...
          (t.cancelChooseFiles = function () {
            t.context.showChooseFilesToolbar &&
              ((m = !1), x(!0), (t.context.showChooseFilesToolbar = !1));
          }),
          (t.showCustomChooseFileModal = function () {
            if (t.task && t.task.files) {
              for (var e = t.task.files, a = {}, n = 0; n < e.length; n++) {
                ...
                if (!i.isDir) {
                  if (
                    ((g = l.getFileExtension(i.fileName)) &&
                      (g = g.toLowerCase()),
                    !(m = a[g]))
                  ) {
                    var s = g;
                    s.length > 0 && "." === s.charAt(0) && (s = s.substring(1)),
                      (m = {
                        extension: s,
                        classified: !1,
                        selected: !1,
              ...
              for (var c in r)
                if (r.hasOwnProperty(c)) {
                  ...
                  p.length > 0 && (o[c] = { name: d, extensions: p });
                }
              var f = [];
              for (var g in a) {
                var m;
              ...
              f.length > 0 && (o.other = { name: "Other", extensions: f }),
                (t.context.fileExtensions = o),
                angular.element("#custom-choose-file-modal").modal();
            }
          }),
          (t.setSelectedExtension = function (e, a) {
            if (t.task && t.task.files) {
              for (var n = t.task.files, i = 0; i < n.length; i++) {
                var s = n[i];
                if (!s.isDir) {
                  var o = l.getFileExtension(s.fileName);
                  o && (o = o.toLowerCase()), o === "." + e && (s.selected = a);
                }
              }
              R();
            }
          ...
          (t.setSelectedFile = function (e) {
            e && R(), t.context.showChooseFilesToolbar || T(!0);
          }),
          (t.collapseDir = function (e, a, n) {
            var i = e.nodePath;
            if (
              (angular.isUndefined(a) && (a = !t.context.collapsedDirs[i]),
              a || n)
            )
              for (var s = 0; s < e.subDirs.length; s++)
                t.collapseDir(e.subDirs[s], a);
            i && (t.context.collapsedDirs[i] = a);
          }),
          (t.collapseAllDirs = function (e) {
            if (t.task && t.task.files)
              for (var a = 0; a < t.task.files.length; a++) {
                var n = t.task.files[a];
                n.isDir && t.collapseDir(n, e, !0);
              }
          }),
          ...
          (t.changePeerListDisplayOrder = function (e, t) {
            var a = l.parseOrderType(c.getPeerListDisplayOrder()),
              n = l.parseOrderType(e);
            t && n.type === a.type && (n.reverse = !a.reverse),
              c.setPeerListDisplayOrder(n.getValue());
          }),
          (t.isSetPeerListDisplayOrder = function (e) {
            var t = l.parseOrderType(c.getPeerListDisplayOrder()),
              a = l.parseOrderType(e);
            return t.equals(a);
          }),
          (t.getPeerListOrderType = function () {
            return c.getPeerListDisplayOrder();
          }),
          (t.loadTaskOption = function (a) {
            e.loadPromise = u.getTaskOptions(a.gid, function (e) {
              e.success && (t.context.options = e.data);
            });
          }),
          (t.setOption = function (e, a, n) {
            return u.setTaskOption(
              t.task.gid,
              e,
              a,
              function (e) {
          ...
          (t.copySelectedRowText = function () {
            if (h) {
              var e = h.find(".setting-key > span").text().trim(),
                t = "";
              if (
                (h.find(".setting-value > span").each(function (e, a) {
                  e > 0 && (t += "\n"), (t += angular.element(a).text().trim());
                }),
                c.getIncludePrefixWhenCopyingFromTaskDetails())
              ) {
                var a = e + ": " + t;
                s.copyText(a);
              } else s.copyText(t);
          ...
          (t.isRpcLocalhost = c.isCurrentRpcLocalhost()),
          (t.backHome = function () {
            window.history.length > 1 ? window.history.back() : n.path("");
          });
      },
    ]);
  })(),
  (function () {
    ...
    angular.module("ariaNg").controller("AriaNgSettingsController", [
      ...
      "ariaNgTitleService",
      "aria2SettingService",
      function (e, t, a, n, i, s, o, r, l, c, d, u, p, f, g, m, h, v, b, k, y) {
        var w = a.extendType,
          S = null,
          x = function () {
            return k.getFinalTitleByGlobalStat({
              globalStat: b.getCurrentGlobalStat(),
              currentRpcProfile: T(),
            });
          },
          T = function () {
            if (
              !t.context ||
              !t.context.rpcSettings ||
              t.context.rpcSettings.length < 1
            )
              return null;
            for (var e = 0; e < t.context.rpcSettings.length; e++) {
              var a = t.context.rpcSettings[e];
              if (a.isDefault) return a;
            }
            return null;
          },
        ...
        (t.context = {
          currentTab: a.tab || "global",
          ariaNgVersion: u.getBuildVersion(),
          buildCommit: u.getBuildCommit(),
          languages: (function () {
            var e = [];
            for (var t in c)
              if (c.hasOwnProperty(t)) {
                var a = c[t];
                e.push({ type: t, name: a.name, displayName: a.displayName });
              }
            return (
              e.sort(function (e, t) {
                return String.naturalCompare(e.type, t.type);
              }),
              e
            );
          })(),
          ...
          showRpcSecret: !1,
          settings: v.getAllOptions(),
          sessionSettings: v.getAllSessionOptions(),
          rpcSettings: v.getAllRpcSettings(),
          isMacKeyboardLike: p.isMacKeyboardLike(),
          isSupportReconnect: y.canReconnect(),
          isSupportBlob: h.isSupportBlob(),
          isSupportDarkMode: v.isBrowserSupportDarkMode(),
          importSettings: null,
          exportSettings: null,
          exportSettingsCopied: !1,
          exportCommandApiOptions: null,
        }),
          (t.context.titlePreview = x()),
          (t.context.showDebugMode =
            t.context.sessionSettings.debugMode || "debug" === w),
          (t.ifDisableInsecureProtocol = function (e) {
            return (
              v.isInsecureProtocolDisabled() &&
          ...
          (t.changeGlobalTab = function () {
            (t.context.currentTab = "global"),
              (e.skipLocationChange = !0),
              n.search("tab", "global").replace();
          }),
          (t.isCurrentGlobalTab = function () {
            return "global" === t.context.currentTab;
          }),
          (t.changeRpcTab = function (a) {
            (t.context.currentTab = "rpc" + a),
              (e.skipLocationChange = !0),
              n.search("tab", "rpc" + a).replace(),
          ...
          (t.getCurrentRpcTabIndex = function () {
            return t.isCurrentGlobalTab()
              ? -1
              : parseInt(t.context.currentTab.substring(3));
          }),
          ...
          (e.swipeActions.extendLeftSwipe = function () {
            var e = -1;
            return (
              t.isCurrentGlobalTab() ||
                (e = parseInt(t.getCurrentRpcTabIndex())),
              e < t.context.rpcSettings.length - 1 &&
                (t.changeRpcTab(e + 1), !0)
            );
          }),
          (e.swipeActions.extendRightSwipe = function () {
            var e = -1;
            return (
              ...
              e > 0
                ? (t.changeRpcTab(e - 1), !0)
                : 0 === e && (t.changeGlobalTab(), !0)
            );
          }),
          (t.isSupportNotification = function () {
            return (
              f.isSupportBrowserNotification() &&
              v.isCurrentRpcUseWebSocket(t.context.settings.protocol)
            );
          }),
          (t.setLanguage = function (e) {
            v.setLanguage(e) && g.applyLanguage(e), t.updateTitlePreview();
          }),
          (t.setTheme = function (t) {
            v.setTheme(t), e.setTheme(t);
          }),
          ...
          (t.setEnableBrowserNotification = function (e) {
            v.setBrowserNotification(e),
              e &&
                !f.hasBrowserPermission() &&
                f.requestBrowserPermission(function (e) {
                  e.granted ||
                    ((t.context.settings.browserNotification = !1),
                    d.showError(
                      "You have disabled notification in your browser. You should change your browser's settings before you enable this function."
                    ));
                });
          }),
          (t.setBrowserNotificationSound = function (e) {
            v.setBrowserNotificationSound(e);
          }),
          (t.setBrowserNotificationFrequency = function (e) {
            v.setBrowserNotificationFrequency(e);
          }),
          (t.setWebSocketReconnectInterval = function (e) {
            C(), v.setWebSocketReconnectInterval(e);
          }),
          (t.setTitleRefreshInterval = function (e) {
            C(), v.setTitleRefreshInterval(e);
          }),
          (t.setGlobalStatRefreshInterval = function (e) {
            C(), v.setGlobalStatRefreshInterval(e);
          }),
          (t.setDownloadTaskRefreshInterval = function (e) {
            C(), v.setDownloadTaskRefreshInterval(e);
          }),
          (t.setRPCListDisplayOrder = function (e) {
            C(), v.setRPCListDisplayOrder(e);
          }),
          (t.setDefaultTaskPage = function (t) {
            (e.defaultTaskPage = t), v.setDefaultTaskPage(t);
          }),
          (t.setTaskListIndependentDisplayOrder = function (e) {
            v.setTaskListIndependentDisplayOrder(e);
          }),
          (t.setKeyboardShortcuts = function (e) {
            v.setKeyboardShortcuts(e);
          }),
          (t.setSwipeGesture = function (e) {
            v.setSwipeGesture(e);
          }),
          (t.setDragAndDropTasks = function (e) {
            v.setDragAndDropTasks(e);
          }),
          (t.setAfterCreatingNewTask = function (e) {
            v.setAfterCreatingNewTask(e);
          }),
          (t.setRemoveOldTaskAfterRetrying = function (e) {
            v.setRemoveOldTaskAfterRetrying(e);
          }),
          (t.setConfirmTaskRemoval = function (e) {
            v.setConfirmTaskRemoval(e);
          }),
          (t.setIncludePrefixWhenCopyingFromTaskDetails = function (e) {
            v.setIncludePrefixWhenCopyingFromTaskDetails(e);
          }),
          (t.setShowPiecesInfoInTaskDetailPage = function (e) {
            v.setShowPiecesInfoInTaskDetailPage(e);
          }),
          (t.setAfterRetryingTask = function (e) {
            v.setAfterRetryingTask(e);
          }),
          ...
          (t.openAriaNgConfigFile = function () {
            h.openFileContent(
              { scope: t, fileFilter: ".json", fileType: "text" },
              function (e) {
          ...
          (t.importSettings = function (e) {
            ...
            try {
              ...
              return (
                ...
                void d.showError("Invalid settings data format!")
              );
            }
            ...
            t &&
              d.confirm(
                ...
                "warning",
                function () {
                  v.importAllOptions(t), i.location.reload();
                }
              );
          }),
          (t.showExportSettingsModal = function () {
            (t.context.exportSettings = r("json")(v.exportAllOptions())),
          ...
          (t.copyExportSettings = function () {
            l.copyText(t.context.exportSettings, {
          ...
          (t.removeRpcSetting = function (e) {
            ...
            d.confirm(
              ...
              function () {
                ...
                v.removeRpcSetting(e),
                  t.context.rpcSettings.splice(n, 1),
                  a >= t.context.rpcSettings.length
                    ? t.changeRpcTab(t.context.rpcSettings.length - 1)
                    : a <= 0 || a <= n || t.changeRpcTab(a - 1);
              },
              !1,
              { textParams: { rpcName: a } }
            );
          }),
          (t.showExportCommandAPIModal = function (e) {
            t.context.exportCommandApiOptions = { type: "setting", data: e };
          }),
          (t.setDefaultRpcSetting = function (e) {
            e.isDefault || (v.setDefaultRpcSetting(e), i.location.reload());
          }),
          (t.resetSettings = function () {
            d.confirm(
              ...
              "warning",
              function () {
                v.resetSettings(), i.location.reload();
              }
            );
          }),
          (t.clearHistory = function () {
            d.confirm(
              ...
              "warning",
              function () {
                y.clearSettingsHistorys(), i.location.reload();
              }
            );
          }),
          (t.resetAria2Settings = function () {
            d.confirm(
              "Confirm Reset",
              "Reset the current Aria2 settings (Will take effect after Aria2 restarts)?",
              "warning",
              function () {
                const e = v.getRpcOptions(),
                  t = y.getDefaultOptions(Object.keys(e));
                y.setGlobalOptions(t, function () {
                  const e = v.getCurrentRpcDisplayName();
                  f.notifyInPage("", "settings are reset", {
                    type: "success",
                    contentPrefix: e + " ",
                  });
                }),
  ...
  (function () {
    ...
    angular.module("ariaNg").controller("Aria2SettingsController", [
      ...
      function (e, t, a, n, i, s, o, r) {
        var l = a.path().substring(a.path().lastIndexOf("/") + 1);
        (t.context = {
          ...
          (t.setGlobalOption = function (e, t, a) {
            return s.setGlobalOption(
              ...
              function (n) {
                n.success && "OK" === n.data
                  ? (a.setSuccess(), o.setRpcOption(e, t))
                  : a.setFailed(n.data.message);
              },
              !0
            );
          }),
          (t.filterOption = function (t) {
            if (
              !(
                t &&
                angular.isObject(t) &&
                angular.isString(t.key) &&
                angular.isString(t.nameKey)
              )
            )
              return !1;
            if (!e.searchContext || !e.searchContext.text) return !0;
            let a = !1;
            const n = e.searchContext.text.toLowerCase();
            return (
              (a |= t.key.toLowerCase().includes(n)),
              (a |= r.getLocalizedText(t.nameKey).includes(n)),
              a
            );
          }),
      ...
      function (e, t, a, n, i, s) {
        (t.context = {
          ...
          (t.reconnect = function () {
            !t.context.isSupportReconnect ||
              ("Disconnected" !== e.taskContext.rpcStatus &&
                "Waiting to reconnect" !== e.taskContext.rpcStatus) ||
              s.reconnect();
          }),
          ...
          e.$watch("taskContext.rpcStatus", function (e) {
            "Connected" === e
              ? (s.getAria2Status(function (e) {
                  e.success && (t.context.serverStatus = e.data);
                }),
                s.getSessionInfo(function (e) {
                  e.success && (t.context.sessionInfo = e.data);
                }))
              : ((t.context.serverStatus = null),
                (t.context.sessionInfo = null));
          }),
  ...
  (function () {
    "use strict";
    angular.module("ariaNg").controller("RecommendController", [
      "$rootScope",
      "$scope",
      "$location",
      "$sce",
      ...
      function (e, t, a, n, i, s) {
        let o = a.search().path || "",
          r = a.hash() ? "#" + a.hash() : "",
          l = s.getLanguage() || "en";
        (l = "zh_Hans" == l ? "" : "zh_Hant" == l ? "/zh-tw" : "/en"),
          (t.recommendUrl = n.trustAsResourceUrl(
            i.recommendOrigin + l + o + r
          ));
        var c = s.getRecCount();
        e.recTotal > c && s.setRecCount(e.recTotal), (e.hasNewRec = !1);
      },
    ]);
  })(),
  (function () {
        ...
        return {
          ...
          link: function (t, a) {
            var n = function () {
              ...
              for (
                var o = 0, r = n.width, l = n.height, c = 0;
                c < i.length;
                c++
              ) {
                var d = i[c],
              ...
              !(function () {
                ...
                if (i && a && i.length === a.length && a.length === n.length) {
                  for (var o = 0; o < n.length; o++)
                    i[o] !== a[o] &&
                      (a[o]
                        ? n[o].addClass("piece-completed")
                        : n[o].removeClass("piece-completed"));
                  i = a;
                } else s();
              })();
            }),
        ...
        function (e, t) {
          return {
            ...
            link: function (a, n, i) {
              ...
              var s = n.find("div"),
                o = n.parent().height(),
                r = parseInt(i.height) || o || 200;
              s.css("height", r + "px");
              var l = echarts.init(s[0], t.get(a.theme)),
                c = function () {
                  l.resize(), a.$apply();
                };
              angular.element(e).on("resize", c),
                a.$watch(
                  "options",
                  function (e) {
                    e &&
                ...
                a.$on("$destroy", function () {
                  l && !l.isDisposed() && l.dispose(),
                    angular.element(e).off("resize", c);
                });
            },
          };
        },
          ...
          return {
            ...
            link: function (e, a, n) {
              ...
              a.popover({
                ...
                template:
                  '<div class="popover chart-popover" role="tooltip"><div class="arrow"></div><div class="popover-body"></div></div>',
                trigger: i.ngTrigger,
              })
                .on("shown.bs.popover", function () {
                  var a = angular.element(".chart-pop"),
                    i = a.parent().height();
                  a.empty();
                  var o = parseInt(n.height) || i || 200;
                  a.css("height", o + "px"),
                    (s = echarts.init(a[0], t.get(e.theme)));
                })
  ...
  (function () {
    "use strict";
    angular.module("ariaNg").directive("ngDragenter", function () {
      return {
        restrict: "A",
        link: function (e, t, a) {
          t.on("dragenter", function (n) {
            e.$eval(a.ngDragenter, { $event: n, element: t });
          });
        },
      };
    }),
      angular.module("ariaNg").directive("ngDragover", function () {
        return {
          restrict: "A",
          link: function (e, t, a) {
            t.on("dragover", function (n) {
              e.$eval(a.ngDragover, { $event: n, element: t });
            });
          },
        };
      }),
      angular.module("ariaNg").directive("ngDragleave", function () {
        return {
          restrict: "A",
          link: function (e, t, a) {
            t.on("dragleave", function (n) {
              e.$eval(a.ngDragleave, { $event: n, element: t });
            });
          },
        };
      }),
      angular.module("ariaNg").directive("ngDrop", function () {
        return {
          restrict: "A",
          link: function (e, t, a) {
            t.on("drop", function (n) {
              e.$eval(a.ngDrop, { $event: n, element: t });
            });
          },
        };
      });
        ...
        return {
          ...
          link: function (a, n, i) {
            a.context = {
              ...
              baseUrl: t.getFullPageUrl(),
              commandAPIUrl: null,
              pauseOnAdded: !0,
              isCopied: !1,
            };
            var s = function () {
                var e = a.context.baseUrl;
                return (
                  e.indexOf("#") >= 0 && (e = e.substring(0, e.indexOf("#"))), e
                );
              },
              o = function (e) {
                var n = s() + "#!/new/task?url=" + t.base64UrlEncode(e.urls[0]);
                if ((a.context.pauseOnAdded && (n += "&pause=true"), e.options))
                  for (var i in e.options)
                    e.options.hasOwnProperty(i) &&
                      (n += "&" + i + "=" + e.options[i]);
                return n;
              };
            (a.generateCommandAPIUrl = function () {
              var e, n;
              a.options &&
                ("new-task" === a.options.type
                  ? (a.context.commandAPIUrl = (function (e) {
                      for (var t = "", a = 0; a < e.length; a++)
                        a > 0 && (t += "\n"), (t += o(e[a]));
                      return t;
                    })(a.options.data))
                  : "setting" === a.options.type &&
                    (a.context.commandAPIUrl =
                      ((e = a.options.data),
                      (n =
                        s() +
                        ...
                        e.rpcInterface),
                      e.secret &&
                        (n += "&secret=" + t.base64UrlEncode(e.secret)),
                      n)),
                (a.context.isCopied = !1));
            }),
              (a.copyCommandAPI = function () {
                e.copyText(a.context.commandAPIUrl, {
                  container: angular.element(n)[0],
                }),
                  (a.context.isCopied = !0);
              }),
              angular.element(n).on("hidden.bs.modal", function () {
                a.$apply(function () {
                  (a.options = null),
                    (a.context.commandAPIUrl = null),
                    (a.context.isCopied = !1);
                });
              }),
              a.$watch(
                ...
                function (e) {
                  e &&
                    (a.generateCommandAPIUrl(),
                    (a.context.isCopied = !1),
                    angular.element(n).modal("show"));
                },
                !0
              );
          },
    ...
    angular.module("ariaNg").directive("ngSetting", [
      ...
      function (e, t, a, n, i, s) {
        return {
          ...
          link: function (o, r, l, c) {
            var d = null,
              u = {
                showPlaceholderCount: !1,
                deleteKeyAlwaysChangeValue: !1,
            ...
            var p,
              f = function () {
                o.option &&
                  o.option.showHistory &&
                  (o.history = s.getSettingHistory(o.option.key));
              },
              g = function () {
                angular.element(r).tooltip("dispose");
              },
              m = function (t, a, i) {
                t &&
                  e(function () {
                    var e = o.optionStatus.getValue();
                    ("failed" !== e && "error" !== e) ||
                      angular
                        .element(r)
                        .tooltip({
                          ...
                          trigger: "focus",
                          placement: u.errorTooltipPlacement,
                          container: r,
                          template:
                            '<div class="tooltip' +
                            (a ? " tooltip-" + a : "") +
            ...
            (o.optionStatus =
              ((p = "ready"),
              {
                ...
                setFailed: function (e) {
                  g(), (p = "failed"), m(e, "warning");
                },
                setError: function (e, t) {
                  g(), (p = "error"), m(e, "error", t);
                },
              ...
              (o.getTotalCount = function () {
                var e = h(o.fixedValue, o.option.separator, o.option.trimCount),
                  t = h(o.optionValue, o.option.separator, o.option.trimCount);
                return (
                  !o.optionValue &&
                    o.showPlaceholderCount &&
                    o.placeholderItemCount &&
                    (t = o.placeholderItemCount),
                  e + t
                );
              }),
              (o.changeValue = function (t, a) {
                if (
                  (d && e.cancel(d),
                  (o.optionValue = t),
                  o.optionStatus.setReady(),
                  o.option && o.option.key && !o.option.readonly)
                )
                  if (o.option.required && "" === t)
                    o.optionStatus.setError("Option value cannot be empty!");
                  else if (
                    "" === t ||
                    "integer" !== o.option.type ||
                    /^-?\d+$/.test(t)
                  )
                    if (
                      "" === t ||
                      ...
                      if (
                        ...
                        ("integer" === o.option.type ||
                          "float" === o.option.type) &&
                        (angular.isDefined(o.option.min) ||
                          angular.isDefined(o.option.max))
                      ) {
                        var n = t;
                        if (
                          ("integer" === o.option.type
                            ? (n = parseInt(t))
                            : "float" === o.option.type && (n = parseFloat(t)),
                          angular.isDefined(o.option.min) && n < o.option.min)
                        )
                          return void o.optionStatus.setError(
                            "Input number is below min value!",
                            { value: o.option.min }
                          );
                        if (angular.isDefined(o.option.max) && n > o.option.max)
                          return void o.optionStatus.setError(
                            "Input number is above max value!",
                            { value: o.option.max }
                          );
                      ...
                      if (
                        "" === t ||
                        !angular.isDefined(o.option.pattern) ||
                        new RegExp(o.option.pattern).test(t)
                      ) {
                        var i = {
                            key: o.option.key,
                            value: t,
                          ...
                          s = function () {
                            o.optionStatus.setSaving(), o.onChangeValue(i);
                          };
                        o.onChangeValue &&
                          (a
                            ? (o.optionStatus.setPending(),
                              (d = e(function () {
                                s();
                              }, u.lazySaveTimeout)))
                            : s());
                      } else o.optionStatus.setError("Input value is invalid!");
                    } else o.optionStatus.setError("Input number is invalid!");
                  else o.optionStatus.setError("Input number is invalid!");
              }),
              (o.inputKeyUp = function (e, t) {
                if (
                  (!0 === u.deleteKeyAlwaysChangeValue ||
                    "true" === u.deleteKeyAlwaysChangeValue) &&
                  (i.isBackspacePressed(e) || i.isDeletePressed(e))
                ) {
                  if (o.optionValue && "" !== o.optionValue) return;
                  o.changeValue("", t);
                }
              }),
              (o.filterHistory = function (e) {
                var a = [];
                if (o.history && e)
                  for (var n = 0; n < o.history.length; n++)
                    0 === o.history[n].indexOf(e) && a.push(o.history[n]);
                return t.resolve(a);
              }),
              c &&
                o.$watch(
              ...
              o.$watch("option", function () {
                f(), r.find('[data-toggle="popover"]').popover();
              }),
              o.$watch("defaultValue", function (e) {
                var t = e;
                if (o.option && o.option.options)
                  for (var a = 0; a < o.option.options.length; a++) {
                    var n = o.option.options[a];
                    if (n.value === e) {
                      t = n.name;
                      break;
                    }
                ...
                (o.placeholder = v(t)),
                  o.option
                    ? (o.placeholderItemCount = h(
                        o.placeholder,
                        o.option.separator,
                        o.option.trimCount
                      ))
                    : (o.placeholderItemCount = 0);
              }),
              (o.showPlaceholderCount =
                !0 === u.showPlaceholderCount ||
                "true" === u.showPlaceholderCount),
              f();
          },
        };
      },
        ...
        return {
          ...
          link: function (n, i, s) {
            (n.context = {
              ...
              (n.setGlobalOption = function (e, n, i) {
                return t.setGlobalOption(
                  e,
                  n,
                  function (t) {
                    t.success && "OK" === t.data
                      ? (i.setSuccess(), a.setRpcOption(e, n))
                      : i.setFailed(t.data.message);
                  },
                  !0
                );
              });
            angular.element(i).on("hidden.bs.modal", function () {
              ...
              n.$watch(
                ...
                function (a) {
                  ...
                  a &&
                    ((s = a.type),
                    (o = t.getAria2QuickSettingsAvailableOptions(s))
                      ? (n.context.availableOptions = t.getSpecifiedOptions(o))
                      : e.showError("Type is illegal!"),
        ...
        link: function (e, t, a) {
          ...
          i && s(),
            e.$watch("title", function () {
              i &&
                angular.element(t).attr("title", e.title).tooltip("_fixTitle");
            }),
            e.$watch("ngTooltipIf", function (e) {
              angular.isUndefined(e) ||
                (i !== (e = !0 === e || "true" === e) &&
                  (e ? s() : angular.element(t).tooltip("dispose"), (i = e)));
            });
        },
      };
    });
            ...
            t.$watch(
              ...
              function (t) {
                if (!angular.isUndefined(t) && "" !== t) {
                  var a = e.parseUrlsFromOriginInput(t, n.urlPattern),
                    s = a && a.length > 0;
                  i.$setValidity("invalidUrls", s);
                }
              }
            );
          },
  ...
  (function () {
    ...
    angular.module("ariaNg").filter("fileOrderBy", [
      ...
      function (e, t) {
        return function (a, n) {
          if (!angular.isArray(a) || !n) return a;
          var i = t.parseOrderType(n);
          return null === i
            ? a
            : "index" === i.type
            ? e("orderBy")(a, ["index"], i.reverse)
            : "name" === i.type
            ? e("orderBy")(a, ["fileName"], i.reverse)
            : "size" === i.type
            ? e("orderBy")(a, ["length"], i.reverse)
            : "percent" === i.type
            ? e("orderBy")(a, ["completePercent"], i.reverse)
            : "selected" === i.type
            ? e("orderBy")(a, ["selected"], i.reverse)
            : a;
        };
      },
    ]);
      ...
      function (e, t) {
        return function (a, n) {
          ...
          return null === i
            ? a
            : "address" === i.type
            ? e("orderBy")(a, ["ip", "port"], i.reverse)
            : "client" === i.type
            ? e("orderBy")(a, ["client.name", "client.version"], i.reverse)
            : "percent" === i.type
            ? e("orderBy")(a, ["completePercent"], i.reverse)
            : "dspeed" === i.type
            ? e("orderBy")(a, ["downloadSpeed"], i.reverse)
            : "uspeed" === i.type
            ? e("orderBy")(a, ["uploadSpeed"], i.reverse)
            : a;
        };
      },
    ]);
      ...
      function (e, t) {
        return function (a, n) {
          ...
          return null === i
            ? a
            : "name" === i.type
            ? e("orderBy")(a, ["taskName"], i.reverse)
            : "size" === i.type
            ? e("orderBy")(a, ["totalLength"], i.reverse)
            : "percent" === i.type
            ? e("orderBy")(a, ["completePercent"], i.reverse)
            : "remain" === i.type
            ? e("orderBy")(a, ["idle", "remainTime", "remainLength"], i.reverse)
            : "dspeed" === i.type
            ? e("orderBy")(a, ["downloadSpeed"], i.reverse)
            : "uspeed" === i.type
            ? e("orderBy")(a, ["uploadSpeed"], i.reverse)
            : "default" === i.type
            ? e("orderBy")(a, ["groupIndex"], i.reverse)
            : a;
        };
      },
    ]);
  ...
  (function () {
    "use strict";
    angular.module("ariaNg").filter("groupTask", function () {
      return function (e) {
  ...
  (function () {
    ...
    angular.module("ariaNg").filter("timeDisplayName", [
      ...
      function (e, t) {
        return function (a, n) {
          if (!a) return t.getLocalizedText(n);
          var i = e.getTimeOption(a);
          return t.getLocalizedText(i.name, { value: i.value });
        };
      },
    ]);
  })(),
      ...
      function (e) {
        ...
        return function (a, n) {
          var i = t[0],
            s = 2,
            o = !1;
          angular.isNumber(n) ? (s = n) : "auto" === n && (o = !0),
            a || (a = 0),
            angular.isNumber(a) || (a = parseInt(a));
          for (var r = 1; r < t.length && a >= 1024; r++)
            (a /= 1024), (i = t[r]);
          return (
            o &&
              (s = (function (e) {
  ...
  (function () {
    "use strict";
    angular.module("ariaNg").factory("SweetAlert", function () {
      return {
        swal: function (e, t) {
          Swal.fire(e).then((e) => t(e));
        },
        close: function () {
          Swal.close();
        },
  ...
  (function () {
    ...
    angular.module("ariaNg").provider("ariaNgAssetsCacheService", [
      function () {
        var e = {},
          t = "languages.";
        (this.getLanguageAsset = function (a) {
          return (function (t) {
            for (var a = t.split("."), n = e, i = 0; i < a.length; i++) {
              if (angular.isUndefined(n[a[i]])) return null;
              n = n[a[i]];
            }
            return n;
          })(t + a);
        }),
          (this.setLanguageAsset = function (a, n) {
            !(function (t, a) {
              for (var n = t.split("."), i = e, s = 0; s < n.length - 1; s++)
                angular.isUndefined(i[n[s]]) && (i[n[s]] = {}), (i = i[n[s]]);
              i[n[n.length - 1]] = a;
            })(t + a, n);
          }),
          (this.$get = function () {
  ...
  (function () {
    ...
    angular.module("ariaNg").factory("ariaNgLanguageLoader", [
      ...
      function (e, t, a, n, i, s, o, r) {
        ...
        return function (l) {
          var c = t.defer();
          if (!n[l.key]) return c.reject(l.key), c.promise;
          var p = a.languageStorageKeyPrefix + "." + l.key,
            f = r.get(p);
          if ((f && c.resolve(f), i.getLanguageAsset(l.key))) {
            var g = d(i.getLanguageAsset(l.key));
            return r.set(p, g), c.resolve(g), c.promise;
          }
          var m = a.languagePath + "/" + l.key + a.languageFileExtension;
          return (
            e({ url: m, method: "GET" })
              .then(function (e) {
                var t = d(e.data),
              ...
              .catch(function (e) {
                return (
                  o.warn("[ariaNgLanguageLoader] cannot get language resource"),
                  f ||
                    s.notifyInPage(
                      "",
      ...
      function (e, t, a, n, i, s, o, r) {
        ...
        return {
          ...
          base64UrlEncode: function (e) {
            return n.urlencode(e);
          },
          base64UrlDecode: function (e) {
            return n.urldecode(e);
          },
          ...
          showDialog: function (e, t, n, i, o) {
            o || (o = {}),
              e && (e = r.getLocalizedText(e)),
              t && (t = r.getLocalizedText(t, o.textParams)),
              (o.confirmButtonText = r.getLocalizedText("OK")),
              (function (e, t, n, i, o) {
                a(function () {
                  s.swal(
                    {
                      ...
                      reverseButtons: !0,
                      inputAutoFocus: !1,
                      confirmButtonText: (o && o.confirmButtonText) || null,
                    },
                    function () {
                      i && i();
                    }
          ...
          confirm: function (e, t, a, n, i, o, l, c) {
            o || (o = {}),
              e && (e = r.getLocalizedText(e)),
              t && (t = r.getLocalizedText(t, o.textParams)),
              o.inputPlaceholder &&
                (o.inputPlaceholder = r.getLocalizedText(o.inputPlaceholder)),
              (o.confirmButtonText = r.getLocalizedText("OK")),
              (o.cancelButtonText = r.getLocalizedText("Cancel")),
              (function (e, t, a, n, i, o, r, l) {
                var c = {
                  title: e,
                  text: t,
                  icon: a,
                  ...
                  preConfirm: l
                    ...
                    : null,
                  inputAutoFocus: !1,
                  input: (o && o.input) || null,
                  inputValue: (o && o.inputValue) || null,
                  inputPlaceholder: (o && o.inputPlaceholder) || null,
                  confirmButtonText: (o && o.confirmButtonText) || null,
                  cancelButtonText: (o && o.cancelButtonText) || null,
                };
                "warning" === a && (c.confirmButtonColor = "#F39C12"),
                  s.swal(c, function (e) {
                    e.isConfirmed ? n && n(e.value) : r && r(e.value);
                  });
              })(e, t, a, n, i, o, l, c);
          },
          ...
          getFileExtensionFromUrl: function (e) {
            let t = ".";
            try {
              let a = new URL(e).pathname.split("/").pop();
              t += a.includes(".") ? a.split(".").pop() : "";
            } catch (e) {
              t = ".";
            }
            return t;
          },
          parseUrlsFromOriginInput: function (e, t) {
            if (!e) return [];
            for (var a = e.split("\n"), n = [], i = 0; i < a.length; i++) {
              var s = a[i];
              if (t)
                try {
                  new RegExp(t, "i").test(s) && n.push(s);
                } catch (e) {
                  console.warn(
                    "[ariaNgCommonService.parseUrlsFromOriginInput] " +
                      e.message,
                    e
                  );
                }
              else
                (s.match(/^(http|https|ftp|sftp):\/\/.+$/i) ||
                  s.match(/^magnet:\?.+$/)) &&
                  n.push(s);
            }
            return n;
          ...
          getLongTimeFromUnixTime: function (e) {
            return i(e, "X").format("HH:mm:ss");
          },
          isUnixTimeAfter: function (e, t, a) {
            return i(e, "X").isAfter(i().add(t, a));
          },
          ...
          formatFilePath: function (e, t = !0) {
            if (!e) return e;
            const a = "/";
            let n = "";
            return (
              e.startsWith(a)
                ? ((n = a), (e = e.replaceAll("\\", a).replaceAll("//", "/")))
                : ((n = "\\"),
                  (e =
                    (e = e
                      .replaceAll(a, "\\")
          ...
          hasDownloadsPermission: function () {
            return e.chrome && e.chrome.downloads;
          },
          getRelativeDir: function (e, t) {
            if ("string" != typeof e || "number" != typeof t) return "";
            const a = e.replaceAll("\\", "/").split("/");
            return a.length > 2 ? a.slice(-t - 1, -1).join("/") + "/" : "";
          },
        };
      },
    ]);
    ...
    angular.module("ariaNg").factory("ariaNgKeyboardService", [
      ...
      function (e) {
        ...
        e.navigator.userAgentData.platform
          ? (t = e.navigator.userAgentData.platform)
          : e.navigator && e.navigator.platform && (t = e.navigator.platform);
        ...
        return {
          ...
          isBackspacePressed: function (e) {
            return "Backspace" === e.code || 8 === i(e);
          },
          isDeletePressed: function (e) {
            return "Delete" === e.code || 46 === i(e);
          },
          isShiftDeletePressed: function (e) {
            return e && e.shiftKey && ("Delete" === e.code || 46 === i(e));
          },
        };
      },
    ]);
    ...
    angular.module("ariaNg").factory("ariaNgNotificationService", [
      ...
      function (e, t, a, n, i, s, o, r) {
        var l = !!e.Notification,
          ...
          u = function () {
            if (
              r.getBrowserNotificationFrequency() &&
              "unlimited" !== r.getBrowserNotificationFrequency()
            ) {
              var e = i.get(a.browserNotificationHistoryStorageKey) || [];
              angular.isArray(e) || (e = []),
                e.push({ time: n.getCurrentUnixTime() }),
                e.length > 10 && e.splice(0, e.length - 10),
                i.set(a.browserNotificationHistoryStorageKey, e);
            }
          },
          p = function (t, s) {
            e.Notification &&
              ...
              ((function () {
                ...
                var t = null,
                  s = !1;
                if ("high" === r.getBrowserNotificationFrequency()) {
                  if (e.length < 10) return !1;
                  (t = e[e.length - 10].time),
                    (s = n.isUnixTimeAfter(t, "-1", "minute"));
                } else
                  "middle" === r.getBrowserNotificationFrequency()
                    ? ((t = e[e.length - 1].time),
                      (s = n.isUnixTimeAfter(t, "-1", "minute")))
                    : "low" === r.getBrowserNotificationFrequency() &&
                      ((t = e[e.length - 1].time),
                      (s = n.isUnixTimeAfter(t, "-5", "minute")));
                return (
                  s &&
                    o.debug(
                      "[ariaNgNotificationService.isReachBrowserNotificationFrequencyLimit] reach frequency limit" +
                        (t ? ", the oldest time is " + t : "")
                    ),
                  s
                );
              })() ||
                (chrome?.runtime?.id
                  ...
                  : ((s = angular.extend({ icon: "tileicon.png" }, s)),
                    u(),
                    new e.Notification(t, s))));
          };
        return {
          ...
          notifyViaBrowser: function (e, t, a) {
            return (
              a || (a = {}),
              e && (e = s.getLocalizedText(e, a.titleParams)),
              t && (t = s.getLocalizedText(t, a.contentParams)),
              (function (e, t, a) {
                a || (a = {}),
                  (a.body = t),
                  r.getBrowserNotificationSound() || (a.silent = !0),
                  l && r.getBrowserNotification() && p(e, a);
              })(e, t, a)
            );
          },
          ...
          notifyInPage: function (e, a, n) {
            return (
              n || (n = {}),
              e && (e = s.getLocalizedText(e, n.titleParams)),
              a &&
                ((a = s.getLocalizedText(a, n.contentParams)),
                n.contentPrefix && (a = n.contentPrefix + a)),
              (function (e, a, n) {
                return (
                  n || (n = {}),
                  a ? ((n.title = e), (n.message = a)) : (n.message = e),
                  (n.type && t[n.type]) || (n.type = "primary"),
                  n.positionY || (n.positionY = "top"),
                  t[n.type](n)
                );
              })(e, a, n)
            );
      ...
      function (e, t) {
        return {
          applyLanguage: function (a) {
            return e.use(a), t.changeLocale(a), !0;
          },
  ...
  (function () {
    ...
    angular.module("ariaNg").factory("ariaNgLogService", [
      ...
      "ariaNgConstants",
      function (e, t) {
        var a = { DEBUG: 1, INFO: 2, WARN: 3, ERROR: 4 },
          n = 0,
          i = !1,
          s = [],
          o = function (e, a, o) {
            i &&
              (s.length >= t.cachedDebugLogsLimit && s.shift(),
              s.push(
                (function (e, t, a) {
                  return {
                    id: ++n,
        ...
        return {
          ...
          compareLogLevel: function (e, t) {
            var n = a[e],
              i = a[t];
            return n || (n = 0), i || (i = 0), n > i ? 1 : n < i ? -1 : 0;
          },
          debug: function (t, a) {
            i &&
              (a
                ? e.debug("[AriaNg Debug]" + t, a)
                : e.debug("[AriaNg Debug]" + t),
              o(t, "DEBUG", a));
          },
          info: function (t, a) {
    ...
    angular.module("ariaNg").factory("ariaNgFileService", [
      ...
      function (e) {
        ...
        return {
          ...
          openFileContent: function (e, a, n, i) {
            t
              ? ((e = angular.extend(
                  {
                    scope: null,
                ...
                i.data("options", e),
                e.fileFilter && i.attr("accept", e.fileFilter),
                i.val(""),
                "true" !== i.attr("data-ariang-file-initialized") &&
                  i
                    .change(function () {
                          ...
                          if (
                            ((s.onload = function () {
                              ...
                              if ("text" === e.fileType)
                                ...
                                t.base64Content = this.result.replace(
                                  /.*?base64,/,
                                  ""
                                );
                              e.successCallback &&
                            ...
                            (s.onerror = function () {
                              e.errorCallback &&
                                (e.scope
                                  ? e.scope.$apply(function () {
                                      e.errorCallback("Failed to load file!");
                                    })
                                  : e.errorCallback("Failed to load file!"));
                            }),
                            "text" === e.fileType)
                ...
                i.trigger("click"))
              : n && n("Your browser does not support loading file!");
          },
          saveFileContent: function (e, t, n) {
            if (a) {
              ...
              var i = new Blob([e], { type: n.contentType }),
  ...
  (function () {
    ...
    angular.module("ariaNg").factory("ariaNgSettingService", [
      ...
      "ariaNgLogService",
      "ariaNgStorageService",
      function (e, t, a, n, i, s, o, r, l) {
        var c = {
            localStorage: l.isLocalStorageSupported(),
            cookies: l.isCookiesSupported(),
          },
          d = c.localStorage || c.cookies,
          u =
            !!e.matchMedia &&
            e.matchMedia("(prefers-color-scheme: dark)") &&
            "not all" !== e.matchMedia("(prefers-color-scheme: dark)").media &&
            angular.isFunction(
              e.matchMedia("(prefers-color-scheme: dark)").addEventListener
            ),
          p = [],
          f = !1,
          g = { debugMode: !1 },
          ...
          h = function () {
            var t = e.navigator.browserLanguage
            ...
            ((t = t.replace(/\-/g, "_")), s[t]) || ((a = m(t)) && (t = a));
            if (!s[t] && t.split("-").length > 1) {
              var a,
                n = t.split("-");
              if (((t = n[0] + "-" + n[1]), !s[t])) (a = m(t)) && (t = a);
            }
            return s[t]
              ? (r.info(
          ...
          b = function () {
            var e,
              t = l.get(n.optionStorageKey);
            if (
              (t &&
                !s[t.language] &&
                (t.language = ((e = t.language), m(e) || h())),
              !t)
            ) {
              if (
                (((t = angular.extend({}, i)).language = h()),
                t.rpcHost || w(t),
                angular.isArray(t.extendRpcServers))
              )
                for (var a = 0; a < t.extendRpcServers.length; a++) {
                  var o = t.extendRpcServers[a];
                  o.rpcHost || w(o);
                }
              v(t),
                (function () {
                  if (d && !(f || !angular.isArray(p) || p.length < 1)) {
          ...
          S = function (e) {
            return {
              ...
              secret: e.secret,
              openHandlerUrl: e.openHandlerUrl,
              rpcOptions: e.rpcOptions,
            };
          },
          x = function () {
            var e = S(i);
            return (e.rpcId = o.generateUniqueId()), w(e), e;
          };
        return {
          ...
          getAllOptions: function () {
            var e = angular.extend({}, i, b());
            if (
              (e.secret && (e.secret = o.base64Decode(e.secret)),
            ...
            if (angular.isArray(e.extendRpcServers))
              for (var n = 0; n < e.extendRpcServers.length; n++) {
                ...
                for (var a in s)
                  s.hasOwnProperty(a) &&
                    o.hasOwnProperty(a) &&
                    (angular.isArray(s[a]) || (o[a] = s[a]));
                t.extendRpcServers.push(o);
              }
            v(t);
          },
          exportAllOptions: function () {
            return angular.extend({}, i, b());
          },
          ...
          setDebugMode: function (e) {
            (g.debugMode = e), r.setEnableDebugLog(e);
          },
          getTitle: function () {
            return k("title");
          },
          ...
          setDragAndDropTasks: function (e) {
            y("dragAndDropTasks", e);
          },
          getRPCListDisplayOrder: function () {
            return k("rpcListDisplayOrder");
          },
          setRPCListDisplayOrder: function (e) {
            y("rpcListDisplayOrder", e);
          },
          getDefaultTaskPage: function () {
            return k("defaultTaskPage");
          },
          setDefaultTaskPage: function (e) {
            y("defaultTaskPage", e);
          },
          ...
          setIncludePrefixWhenCopyingFromTaskDetails: function (e) {
            y("includePrefixWhenCopyingFromTaskDetails", e);
          },
          ...
          isCurrentRpcLocalhost: function () {
            var e = k("rpcHost");
            return /^(localhost|127\.0\.0\.1|\[::1\])$/i.test(e);
          },
          ...
          addNewRpcSetting: function () {
            ...
            var t = x();
            return e.extendRpcServers.push(t), v(e), t;
          },
          ...
          setDefaultRpcSetting: function (e, t) {
            ...
            for (var i = null, s = 0; s < a.extendRpcServers.length; s++)
              if (a.extendRpcServers[s].rpcId === e.rpcId) {
                (i = S(a.extendRpcServers[s])), a.extendRpcServers.splice(s, 1);
                break;
              }
            return (
              t.forceSet &&
                (i = S(e)).secret &&
                (i.secret = o.base64Encode(i.secret)),
              i &&
          ...
          isRpcSettingEqualsDefault: function (e) {
            ...
            return (
              ...
              t.rpcRequestHeaders === e.rpcRequestHeaders &&
              t.secret === e.secret
            );
          },
          getTaskListIndependentDisplayOrder: function () {
            return k("taskListIndependentDisplayOrder");
          },
          setTaskListIndependentDisplayOrder: function (e) {
            y("taskListIndependentDisplayOrder", e);
          },
          getTaskListDisplayOrderKey: function (e) {
            var t = "displayOrder";
            return (
              this.getTaskListIndependentDisplayOrder() &&
                ("waiting" === e
                  ? (t = "waitingTaskListPageDisplayOrder")
                  : "stopped" === e
                  ? (t = "stoppedTaskListPageDisplayOrder")
                  : "downloading" === e &&
                    (t = "downloadingTaskListPageDisplayOrder")),
              t
            );
          },
          ...
          setRecCount: function (e) {
            y("recCount", e);
          },
          getRpcOptions: function () {
            return k("rpcOptions");
          },
          setRpcOption: function (e, t) {
            const a = k("rpcOptions");
            t ? (a[e] = t) : delete a[e], y("rpcOptions", a);
            const n = b();
            chrome.storage?.local.set({ ariaNgOptions: n });
          },
          getCompactMode: function () {
            return k("compactMode");
          },
          setCompactMode: function (e) {
            y("compactMode", e);
          },
          resetRpcOptions: function () {
            y("rpcOptions", {});
            const e = b();
            chrome.storage?.local.set({ ariaNgOptions: e });
          },
      ...
      function (e, t, a, n) {
              ...
              var i = {
                  ...
                  tooltip: {
                    ...
                    formatter: function (t) {
                      if ("" === t[0].name)
                        return (
                          "<div>" + n.getLocalizedText("No Data") + "</div>"
                        );
        ...
        return {
            ...
            c(e) || l(e),
              ...
              (function (e, t) {
                var a = s[e],
                  ...
                  i = a.series[0].data,
                  o = a.series[1].data;
                n.length >= r(e) && (n.shift(), i.shift(), o.shift()),
                  n.push(t.time),
          ...
          recordGlobalStat: function (e) {
            this.recordStat(o, e), (i = e);
          },
          getGlobalStatsData: function () {
            return this.getStatsData(o);
          },
      ...
      function (e, t, a, n) {
        var i = function (e) {
          ...
          s = function (t, a) {
            var n = a.value;
            return (
              "volume" === a.type && (n = e("readableVolume")(n, a.scale)),
        ...
        return {
          getFinalTitle: function (e) {
            ...
            return i
              ? (i = (function (e) {
                  return o(e, "title", { value: t.title });
                })(
                  (i = (function (e, t) {
                    return o(e, "upspeed", {
                    ...
                    (i = (function (e, t) {
                      ...
                      (i = (function (e, t) {
                        return o(e, "stopped", {
                          prefix:
                            a.getLocalizedText("Finished / Stopped") + ": ",
                          value: t,
                        });
                      })(
                        (i = (function (e, t) {
  ...
  (function () {
    ...
    angular.module("ariaNg").factory("aria2HttpRpcService", [
      ...
      "ariaNgLogService",
      function (e, t, a, n, i) {
        var s = n.getCurrentRpcUrl(),
          o = n.getCurrentRpcHttpMethod(),
          r = n.getCurrentRpcRequestHeaders();
        return {
          request: function (n) {
            if (n) {
              var l = {
                ...
                method: o,
                headers: {},
                timeout: t.httpRequestTimeout,
              };
              if (
                ("POST" === l.method
                  ? ((l.data = angular.toJson(n.requestBody)),
                    ...
                    (l.url = (function (e, t) {
                      ...
                      for (var i in t)
                        if (t.hasOwnProperty(i)) {
                          var s = t[i];
                          null === s ||
                            angular.isUndefined(s) ||
                            (n.length > 0 && (n += "&"),
                            (angular.isObject(s) || angular.isArray(s)) &&
                              ((s = angular.toJson(s)),
                              (s = a.base64Encode(s)),
              ...
              return (
                i.debug(
                  "[aria2HttpRpcService.request] " +
                    (n && n.requestBody && n.requestBody.method
                    ...
                    i.debug(
                      ...
                      t &&
                        (n.connectionSuccessCallback &&
                          n.connectionSuccessCallback({ rpcUrl: s, method: o }),
                        n.successCallback && n.successCallback(t.id, t.result));
                  })
                  .catch(function (e) {
                    var t = e.data;
                    i.debug(
                      ...
                      t ||
                        ((t = {
                          id: "-1",
                          error: { message: "Cannot connect to aria2!" },
                        }),
                        n.connectionFailedCallback &&
                          n.connectionFailedCallback({ rpcUrl: s, method: o })),
                      n.errorCallback && n.errorCallback(t.id, t.error);
                  })
              );
            }
          },
      ...
      function (e, t, a, n, i, s) {
        var o = i.getCurrentRpcUrl(),
          ...
          u = function (e) {
            if (null === r)
              try {
                (r = t(o, {
                  maxTimeout: 1,
                  reconnectInterval: i.getWebSocketReconnectInterval(),
                            ...
                            if (t) {
                              ...
                              if (a) {
                                ...
                                a.deferred.resolve({ success: !0, context: n }),
                                  e.result &&
                                    n.connectionSuccessCallback &&
                                    n.connectionSuccessCallback({ rpcUrl: o }),
                                  e.result &&
                                    n.successCallback &&
                                    (s.debug(
                      ...
                      (function (e) {
                        ...
                        if (t) {
                          ...
                          if (a) {
                            ...
                            if (n) {
                              var i = n.context;
                              n.deferred.reject({ success: !1, context: i }),
                                i.errorCallback &&
                                  (s.debug(
                                    "[aria2WebSocketRpcService.processRequestFailed] " +
                                      (i &&
                                      i.requestBody &&
                                      i.requestBody.method
                                        ? i.requestBody.method + " "
                                        : "") +
                                      "request failed"
                                  ),
                  ...
                  r.onOpen(function (t) {
                    s.debug(
                      ...
                      e &&
                        e.connectionSuccessCallback &&
                        e.connectionSuccessCallback({ rpcUrl: o });
                  }),
                      ...
                      if (c.hasOwnProperty(a)) {
                        ...
                        n
                          ? (n.deferred.reject({
                            ...
                            s.debug(
                              "[aria2WebSocketRpcService.socketClient.onClose] reject old request",
                              n.context
                            ),
                            n.context.errorCallback(n.context.id, {
                              message: "Cannot connect to aria2!",
                            }),
                            delete c[a])
                          : delete c[a];
                      }
                    var r = i.getWebSocketReconnectInterval() > 0;
                    r && f(e),
                      r && e && e.connectionWaitingToReconnectCallback
                        ? e.connectionWaitingToReconnectCallback({ rpcUrl: o })
                        : e &&
                          e.connectionFailedCallback &&
                          e.connectionFailedCallback({ rpcUrl: o });
                  });
              } catch (e) {
                return {
                  success: !1,
          ...
          p = function (e) {
            e &&
              r &&
              (e.connectionReconnectingCallback &&
                e.connectionReconnectingCallback({ rpcUrl: o }),
              r.reconnect());
          },
          f = function (e) {
            l
              ...
              : ((l = a(function () {
                  return null == r
                    ...
                    ? (s.warn(
                      ...
                      void (l = null))
                    : (p(e), void (l = null));
                }, i.getWebSocketReconnectInterval())),
                s.debug(
        ...
        return {
          request: function (t) {
            if (t) {
              var a = u({
                  connectionSuccessCallback: t.connectionSuccessCallback,
                  connectionFailedCallback: t.connectionFailedCallback,
                  connectionReconnectingCallback:
                    t.connectionReconnectingCallback,
                  connectionWaitingToReconnectCallback:
                    t.connectionWaitingToReconnectCallback,
                }),
                n = t.uniqueId,
                i = angular.toJson(t.requestBody);
              s.debug(
                "[aria2WebSocketRpcService.request] " +
                  (t && t.requestBody && t.requestBody.method
                    ? t.requestBody.method + " "
                    : "") +
                  "request start",
                t
              );
              ...
              return (
                a.instance
                  ? ((c[n] = { context: t, deferred: o }), a.instance.send(i))
                  : (o.reject({ success: !1, context: t }),
                    s.debug(
                      "[aria2WebSocketRpcService.request] client error",
                      a
                    ),
                    t.errorCallback(t.id, { message: a.error })),
                o.promise
              );
            }
          },
  ...
  (function () {
    ...
    angular.module("ariaNg").factory("aria2RpcService", [
      ...
      function (e, t, a, n, i, s, o, r, l, c, d) {
        var u = r.isCurrentRpcUseWebSocket() ? d : c,
          p = !1,
          f = r.getCurrentRpcSecret(),
          g = [],
          m = [],
          h = [],
          v = [],
          ...
          P = [],
          R = function (e) {
            return 0 === e.indexOf(a.rpcSystemServiceName + ".");
          },
          D = function (e) {
            return a.rpcServiceName + "." + e;
          },
          A = function (e, t) {
            if (t) return e;
            var n = s.generateUniqueId(),
              i = {
                uniqueId: n,
                requestBody: {
                  jsonrpc: a.rpcServiceVersion,
                  method: e.methodName,
                  id: n,
                  params: e.params,
                },
                ...
                connectionReconnectingCallback:
                  e.connectionReconnectingCallback,
                connectionWaitingToReconnectCallback:
                  e.connectionWaitingToReconnectCallback,
          ...
          I = function (e, a, n) {
            for (var i = [], s = !1, o = !1, r = [], l = 0; l < a.length; l++)
              (a[l].callback = function (e) {
                r.push(e), (s = s || e.success), (o = o || !e.success);
              }),
                i.push(e(a[l]));
            return t.all(i).finally(function () {
              n && n({ hasSuccess: !!s, hasError: !!o, results: r });
            });
          },
          L = function (e) {
            if (!e || !e.message) return !1;
            o.warn("[aria2RpcService.processError] " + e.message, e);
            let t = null;
            return (
              (t = s.hasDownloadsPermission()
                ? function (e) {
                    l.notifyInPage("", e, {
                      type: "error",
                      replaceMessage: !1,
                ...
                : s.showError.bind(s)),
              n[e.message] && n[e.message].tipTextKey
                ? (t(n[e.message].tipTextKey), !0)
                : (t(e.message), !0)
            );
          },
          F = function () {
            ...
            if (
              (f && !i && s.push(a.rpcTokenPrefix + f), arguments.length > 1)
            ) {
              var l = arguments[1];
              (o.successCallback = function (e, t) {
                if (
                  (l.callback &&
                    l.callback({ id: e, success: !0, data: t, context: l }),
                  N(m),
                  !p)
                ) {
                  p = !0;
                  var a = { rpcName: r.getCurrentRpcDisplayName() };
                  N(g, a);
                }
              }),
                (o.errorCallback = function (t, a) {
                  var i = !1,
                    s = e.path();
                  l.silent || s !== n || (i = L(a)),
                    l.callback &&
            ...
            if (arguments.length > 2)
              for (var c = 2; c < arguments.length; c++)
                null !== arguments[c] &&
                  angular.isDefined(arguments[c]) &&
                  s.push(arguments[c]);
            return s.length > 0 && (o.params = s), o;
          },
          U = function (e, t) {
            var a = angular.copy(e);
            for (var n in a)
              a.hasOwnProperty(n) && M(a, n) && (a[n] = E(a[n], i[n]));
          ...
          E = function (e, t) {
            for (
              var a = e.split(t.separator), n = [], i = 0;
              i < a.length;
              i++
            ) {
              var s = a[i];
        ...
        return (
          ...
          O("onDownloadPause", S),
          O("onDownloadStop", x),
          O("onDownloadComplete", T),
          O("onDownloadError", C),
          O("onBtDownloadComplete", P),
          {
            ...
            canReconnect: function () {
              return r.isCurrentRpcUseWebSocket();
            },
            reconnect: function (e) {
              o.info("[aria2RpcService.reconnect] reconnect now"),
                u.reconnect(F("", e));
            },
            addUri: function (e, t) {
              var a = e.task ? e.task.urls : null,
                n = U(e.task ? e.task.options : {}, e);
              return A(F("addUri", e, a, n), !!t);
            },
            addUriMulti: function (e) {
              ...
              return I(this.addUri, t, e.callback);
            },
            addTorrent: function (e, t) {
              var a = e.task ? e.task.content : null,
                n = U(e.task ? e.task.options : {}, e);
              return A(F("addTorrent", e, a, [], n), !!t);
            },
            addMetalink: function (e, t) {
              var a = e.task ? e.task.content : null,
                n = U(e.task ? e.task.options : {}, e);
              return A(F("addMetalink", e, a, n), !!t);
            },
            remove: function (e, t) {
              return A(F("remove", e, e.gid, e.removeFile), !!t);
            },
            forceRemove: function (e, t) {
              return A(F("forceRemove", e, e.gid, e.removeFile), !!t);
            },
            forceRemoveMulti: function (e) {
              ...
              return I(this.forceRemove, t, e.callback);
            },
            pause: function (e, t) {
              return A(F("pause", e, e.gid), !!t);
            },
            pauseAll: function (e, t) {
              return A(F("pauseAll", e), !!t);
            },
            forcePause: function (e, t) {
              return A(F("forcePause", e, e.gid), !!t);
            },
            forcePauseMulti: function (e) {
              for (var t = [], a = 0; a < e.gids.length; a++)
                t.push({ silent: !!e.silent, gid: e.gids[a] });
              return I(this.forcePause, t, e.callback);
            },
            forcePauseAll: function (e, t) {
              return A(F("forcePauseAll", e), !!t);
            },
            unpause: function (e, t) {
              return A(F("unpause", e, e.gid), !!t);
            },
            unpauseMulti: function (e) {
              for (var t = [], a = 0; a < e.gids.length; a++)
                t.push({ silent: !!e.silent, gid: e.gids[a] });
              return I(this.unpause, t, e.callback);
            },
            unpauseAll: function (e, t) {
              return A(F("unpauseAll", e), !!t);
            },
            tellStatus: function (e, t) {
              return A(F("tellStatus", e, e.gid), !!t);
            },
            getUris: function (e, t) {
              return A(F("getUris", e, e.gid), !!t);
            },
            getFiles: function (e, t) {
              return A(F("getFiles", e, e.gid), !!t);
            },
            getPeers: function (e, t) {
              return A(F("getPeers", e, e.gid), !!t);
            },
            getServers: function (e, t) {
              return A(F("getServers", e, e.gid), !!t);
            },
            ...
            tellAllTasks: function (e, a) {
              ...
              return (function (e, a, n) {
                ...
                console.warn(
                  "aria2RpcService.invokeMultiMethods: invalid params!"
                );
              })(
            ...
            changePosition: function (e, t) {
              return A(F("changePosition", e, e.gid, e.pos, e.how), !!t);
            },
            changeUri: function (e, t) {
              return A(
                F("changeUri", e, e.gid, e.fileIndex, e.delUris, e.addUris),
                !!t
              );
            },
            getOption: function (e, t) {
              return A(F("getOption", e, e.gid), !!t);
            },
            changeOption: function (e, t) {
              var a = U(e.options, e);
              return A(F("changeOption", e, e.gid, a), !!t);
            },
            getGlobalOption: function (e, t) {
              return A(F("getGlobalOption", e), !!t);
            },
            changeGlobalOption: function (e, t) {
              var a = U(e.options, e);
              return A(F("changeGlobalOption", e, a), !!t);
            },
            getGlobalStat: function (e, t) {
              return A(F("getGlobalStat", e), !!t);
            },
            purgeDownloadResult: function (e, t) {
              return A(F("purgeDownloadResult", e), !!t);
            },
            removeDownloadResult: function (e, t) {
              return A(F("removeDownloadResult", e, e.gid, e.removeFile), !!t);
            },
            removeDownloadResultMulti: function (e) {
              ...
              return I(this.removeDownloadResult, t, e.callback);
            },
            getVersion: function (e, t) {
              return A(F("getVersion", e), !!t);
            },
            getSessionInfo: function (e, t) {
              return A(F("getSessionInfo", e), !!t);
            },
            shutdown: function (e, t) {
              return A(F("shutdown", e), !!t);
            },
            forceShutdown: function (e, t) {
              return A(F("forceShutdown", e), !!t);
            },
            saveSession: function (e, t) {
              return A(F("saveSession", e), !!t);
            },
            multicall: function (e, t) {
              return A(F("system.multicall", e, e.methods), !!t);
            },
            listMethods: function (e, t) {
              return A(F("system.listMethods", e), !!t);
            },
            listNotifications: function (e, t) {
              return A(F("system.listNotifications", e), !!t);
            },
  ...
  (function () {
    ...
    angular.module("ariaNg").factory("aria2TaskService", [
      ...
      function (e, t, a, n, i, s, o, r, l) {
        var c = function (e) {
            if (!e)
              return r.warn("[aria2TaskService.getFileName] file is null"), "";
            var t = e.path,
              a = !1;
            !t &&
              e.uris &&
              ...
              ((t = e.uris[0].uri), (a = !0));
            var n = t.lastIndexOf("/");
            if ((n < 0 && (n = t.lastIndexOf("\\")), n <= 0 || n === t.length))
              return t;
            var i = t.substring(n + 1),
              s = i.indexOf("?"),
              o = i;
            if ((s > 0 && (o = i.substring(0, s)), a))
              try {
                o = decodeURI(o);
              } catch (e) {
                r.warn(
          ...
          d = function (e, t) {
            ...
            var s = function () {
              i.length > 1 &&
                i.charAt(0) === a.defaultPathSeparator &&
                (i = i.substr(1));
            };
            if (
              (n && 0 === i.indexOf(n) && (i = i.substr(n.length)),
              s(),
              e.bittorrent &&
              ...
              var o = e.bittorrent.info.name;
              0 === i.indexOf(o) && (i = i.substr(o.length));
            }
            return (
              s(),
              t.fileName &&
                i.lastIndexOf(t.fileName) + t.fileName.length === i.length &&
                (i = i.substr(0, i.length - t.fileName.length)),
              i.length > 1 &&
                i.charAt(i.length - 1) === a.defaultPathSeparator &&
          ...
          u = function (e, t, n) {
            ...
            if (e.length) {
              ...
              l > 0 && ((r = e.substring(0, l)), (o = e.substring(l + 1))),
                (s = u(r, t, n));
            }
            return (
              (i = {
          ...
          f = function (e, t, a) {
            if (e) {
              ...
              (e.length = n),
                ...
                (e.partialSelected =
                  (i > 0 && i < e.subDirs.length + e.files.length) || s > 0);
            }
          },
          g = function (e, t) {
          ...
          m = function (e, t) {
            if (!e)
              return (
                r.warn("[aria2TaskService.processDownloadTask] task is null"), e
              );
            t = t && e.bittorrent && "multi" === e.bittorrent.mode;
            var a,
              i,
              l = g(e.bitfield, e.numPieces);
            if (
              ...
              e.files.forEach((e) => {
                ...
                (e.verifiedPercent =
                  t > 0 ? parseInt((e.verifiedLength / t) * 100) : void 0);
            } else e.verifiedPercent = void 0;
            e.dir = s.formatFilePath(e.dir);
            var u = (function (e) {
              var t = "",
                a = !0;
              return (
                e.bittorrent &&
                  e.bittorrent.info &&
                  (t = e.bittorrent.info.name),
                e.bittorrent &&
                  e.files.length > 0 &&
                  e.files[0].path.includes("[METADATA]") &&
                  (e.files[0].path =
                    e.dir +
                    e.files[0].path.replace("[METADATA]", "") +
                    ".torrent"),
                !t && e.files && e.files.length > 0 && (t = c(e.files[0])),
                t || ((t = o.getLocalizedText("Unknown")), (a = !1)),
                { name: t, success: a }
              );
            })(e);
            if (
              ((e.taskName = u.name),
              (e.hasTaskName = u.success),
              (e.errorDescription = (function (e) {
                return e.errorCode &&
                  n[e.errorCode] &&
                  n[e.errorCode].descriptionKey
                  ? n[e.errorCode].hide
                    ? ""
                    : n[e.errorCode].descriptionKey
                  : "";
              ...
              for (var m = 0, h = [], v = {}, b = 0; b < e.files.length; b++) {
                var k = e.files[b];
                if (
                  ((k.index = parseInt(k.index)),
                  (k.fileName = c(k)),
                  (k.path = s.formatFilePath(k.path, !1)),
                  (k.length = parseInt(k.length)),
                  (k.selected = !0 === k.selected || "true" === k.selected),
                  (k.completedLength = parseInt(k.completedLength)),
                  (k.completePercent =
                    k.length > 0 ? (k.completedLength / k.length) * 100 : 0),
                  t)
                ) {
                  k.relativePath = d(e, k);
                  var y = p(k, h, v);
                  k.level = y.level + 1;
                }
                m += k.selected ? 1 : 0;
              ...
              if (t && h.length > 1) {
                var w = [];
                f(v[""], v, w), (e.files = w), (e.multiDir = !0);
              }
              e.selectedFileCount = m;
            }
            if (
              e.files &&
              1 === e.files.length &&
              ...
              var S = !0,
                x = e.files[0].uris[0].uri;
              for (b = 0; b < e.files[0].uris.length; b++) {
                if (e.files[0].uris[b].uri !== x) {
                  S = !1;
                  break;
                }
              }
          ...
          h = function (e, a, n) {
            if (!e)
              return (
                r.warn("[aria2TaskService.processBtPeers] peers is null"), e
              );
            for (
              var i = g(a.bitfield, a.numPieces),
                o = s.countArray(i, !0),
                l = a.completePercent,
                c = 0;
              c < e.length;
              ...
              var d = e[c],
                u = parseInt(d.uploadSpeed),
                p = parseInt(d.downloadSpeed),
                f = g(d.bitfield, a.numPieces),
                m = s.countArray(f, !0);
              if (
                ((d.name = d.ip + ":" + d.port),
                (d.completePercent = (m / a.numPieces) * 100),
                (d.downloadSpeed = u),
                (d.uploadSpeed = p),
                (d.seeder = !0 === d.seeder || "true" === d.seeder),
                m === o && d.completePercent !== l && (d.completePercent = l),
                d.peerId)
              ) {
                var h = s.decodePercentEncodedString(d.peerId),
                  v = h ? t.parseClient(h) : null;
                if (v && "unknown" !== v.client) {
                  var k = {
                    name: v.client ? v.client.trim() : "",
                    version: v.version ? v.version.trim() : "",
                  };
                  (k.info = k.name + (k.version ? " " + k.version : "")),
                    (d.client = k);
                }
              }
            }
            return n && e.push(b(a)), e;
          },
          v = function (e, t, a) {
            return function (n) {
              var i = { type: a, task: null };
              n && n.gid
                ? e(
                    n.gid,
                    function (e) {
        ...
        return {
          getTaskList: function (e, t, a, n) {
            ...
            else if ("stopped" === e) s = i.tellStopped;
            else {
              if ("all" !== e) return;
              s = i.tellAllTasks.bind(i);
            }
            return s({
              requestWholeInfo: t,
              ...
              callback: function (e) {
                a
                  ? a(e)
                  : r.warn("[aria2TaskService.getTaskList] callback is null");
              },
            });
          },
          getTaskStatus: function (e, t, a, n) {
            return i.tellStatus({
              ...
              callback: function (e) {
                t
                  ? (e.success && m(e.data, n), t(e))
                  : r.warn("[aria2TaskService.getTaskStatus] callback is null");
              },
            });
          },
          getTaskOptions: function (e, t, a) {
            return i.getOption({ gid: e, silent: !!a, callback: t });
          },
          setTaskOption: function (e, t, a, n, s) {
            var o = {};
            return (
              (o[t] = a),
              i.changeOption({ gid: e, options: o, silent: !!s, callback: n })
            );
          },
          ...
          getTaskStatusAndBtPeers: function (e, t, a, n, s, o) {
            var l = [i.tellStatus({ gid: e }, !0)];
            return (
              n && l.push(i.getPeers({ gid: e }, !0)),
              i.multicall({
                methods: l,
                silent: !!a,
                callback: function (e) {
                  t
                    ? ((e.task = {}),
                      e.success &&
                        e.data.length > 0 &&
                        ((e.task = e.data[0][0]), m(e.task, o)),
                      e.success &&
                        e.task.bittorrent &&
                        e.data.length > 1 &&
                        ((e.peers = e.data[1][0]), h(e.peers, e.task, s)),
                      t(e))
                    : r.warn(
          ...
          startTasks: function (e, t, a) {
            return i.unpauseMulti({ gids: e, silent: !!a, callback: t });
          },
          pauseTasks: function (e, t, a) {
            return i.forcePauseMulti({ gids: e, silent: !!a, callback: t });
          },
          retryTask: function (t, a, n) {
            var s = e.defer(),
              o = [i.tellStatus({ gid: t }, !0), i.getOption({ gid: t }, !0)],
              c = null,
              d = null;
            return (
              i.multicall({
                ...
                callback: function (e) {
                  if (a) {
                    ...
                    if (
                      ...
                      return (
                        c ||
                          r.warn("[aria2TaskService.retryTask] task is null"),
                        d ||
                          r.warn(
                    ...
                    i.addUri({
                      ...
                      callback: function (e) {
                        ...
                        l.getRemoveOldTaskAfterRetrying() &&
                    ...
                    r.warn("[aria2TaskService.retryTask] callback is null");
                },
              }),
              s.promise
            );
          ...
          retryTasks: function (t, a, n) {
            ...
            r.warn("[aria2TaskService.retryTasks] callback is null");
          },
          removeTasks: function (t, a, n, o) {
            for (var r = [], l = [], c = !1, d = 0; d < t.length; d++)
              "complete" === t[d].status ||
              "error" === t[d].status ||
              "removed" === t[d].status
                ? l.push(t[d].gid)
                : (r.push(t[d].gid), "active" === t[d].status && (c = !0));
            var u = [],
              p = !1,
              f = !1,
              g = [];
          ...
          clearStoppedTasks: function (e, t) {
            return i.purgeDownloadResult({ silent: !!t, callback: e });
          },
          onConnectionSuccess: function (e) {
            e
              ? i.onConnectionSuccess({ callback: e })
              : r.warn(
          ...
          onConnectionFailed: function (e) {
            e
              ? i.onConnectionFailed({ callback: e })
              : r.warn(
          ...
          onConnectionReconnecting: function (e) {
            e
              ? i.onConnectionReconnecting({ callback: e })
              : r.warn(
          ...
          onConnectionWaitingToReconnect: function (e) {
            e
              ? i.onConnectionWaitingToReconnect({ callback: e })
              : r.warn(
          ...
          onFirstSuccess: function (e) {
            e
              ? i.onFirstSuccess({ callback: e })
              : r.warn("[aria2TaskService.onFirstSuccess] callback is null");
          },
          onOperationSuccess: function (e) {
            e
              ? i.onOperationSuccess({ callback: e })
              : r.warn(
          ...
          onOperationError: function (e) {
            e
              ? i.onOperationError({ callback: e })
              : r.warn("[aria2TaskService.onOperationError] callback is null");
          },
          onTaskCompleted: function (e) {
            e
              ? i.onDownloadComplete({
                  callback: v(this.getTaskStatus, e, "completed"),
                })
              : r.warn("[aria2TaskService.onTaskCompleted] callback is null");
          },
          onBtTaskCompleted: function (e) {
            e
              ? i.onBtDownloadComplete({
                  callback: v(this.getTaskStatus, e, "btcompleted"),
                })
              : r.warn("[aria2TaskService.onBtTaskCompleted] callback is null");
          },
          onTaskErrorOccur: function (e) {
            e
              ? i.onDownloadError({
                  callback: v(this.getTaskStatus, e, "error"),
                })
              : r.warn("[aria2TaskService.onTaskErrorOccur] callback is null");
          },
          ...
          getCombinedPieces: function (e, t) {
            return (function (e, t) {
              for (var a = g(e, t), n = [], i = 0; i < a.length; i++) {
                var s = a[i];
                n.length > 0 && n[n.length - 1].isCompleted === s
                  ? n[n.length - 1].count++
          ...
          estimateHealthPercentFromPeers: function (e, t) {
            ...
            for (s = 0; s < t.length; s++) {
              for (
                var o = t[s], l = g(o.bitfield, e.numPieces), c = 0, d = 0;
                d < l.length;
                d++
              ) {
                var u = l[d] ? 1 : 0;
              ...
              c > n
                ? ((n = c), (i = o.completePercent))
                : c === n && o.completePercent > i && (i = o.completePercent);
            }
            var p = 0;
            if (a.length > 0)
              for (;;) {
    ...
    angular.module("ariaNg").factory("aria2SettingService", [
      ...
      function (e, t, a, n, i, s, o, r) {
        ...
        return {
          ...
          isOptionKeyRequired: function (e) {
            var a = t[e];
            return a && a.required;
          },
          ...
          getAvailableTaskOptionKeys: function (e, t) {
            for (var a = i.taskOptions, n = [], s = 0; s < a.length; s++) {
              var o = a[s],
                r = { key: o.key, category: o.category };
              (o.canShow && o.canShow.indexOf(e) < 0) ||
                ("http" === o.category && t) ||
                (("bittorrent" !== o.category || t) &&
                  (o.canUpdate &&
                    o.canUpdate.indexOf(e) < 0 &&
                    (r.readonly = !0),
                  n.push(r)));
            }
            return n;
          ...
          getDefaultOptions: function (e) {
            ...
            for (const n of e)
              t[n]?.hasOwnProperty("defaultValue") &&
                (a[n] = t[n].defaultValue);
            return a;
          },
          ...
          getSettingHistory: function (t) {
            if (!this.isOptionKeyValid(t)) return [];
            for (
              var a = l(t), n = r.get(a) || [], i = [], s = 0;
              s < Math.min(n.length, e.historyMaxStoreCount);
              s++
            )
              i.push(n[s]);
            return i;
          ...
          addSettingHistory: function (t, a) {
            ...
            for (
              var o = 0;
              o < Math.min(i.length, e.historyMaxStoreCount - 1);
              o++
            )
              i[o] !== a && s.push(i[o]);
            return r.set(n, s), s;
          ...
          clearSettingsHistorys: function () {
            for (
              var t = r.keys(e.settingHistoryKeyPrefix + "."), a = 0;
              a < t.length;
              a++
            )
              r.remove(t[a]);
          ...
          setGlobalOptions: function (e, t, a) {
            return s.changeGlobalOption({
              options: e,
              silent: !!a,
              callback: t,
            });
          ...
          getSessionInfo: function (e, t) {
            return s.getSessionInfo({ silent: !!t, callback: e });
          },
          getGlobalStat: function (e, t) {
  ...
  (function () {
    "use strict";
    angular.module("ariaNg").factory("aria2eRecService", [
      "aria2eConstants",
      function (e) {
        return {
          getRecManifestPromise: function () {
            return new Promise((t, a) => {
              let n = e.recManifestUrl;
              fetch(n)
                .then((e) => {
                  t(e.json());
                })
